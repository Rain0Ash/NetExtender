...
namespace NetExtender.ImageSharp.Utils
{
    public static class SharpImageHashingUtils
    {
        ...
        public static UInt64 PerceptualHashing(Image<Rgba32> image)
        {
            ...
            static Double[] Dct1D(IReadOnlyList<Double> values)
            {
                ...
                for (Int32 coefficient = 0; coefficient < Size; coefficient++)
                {
                    ...
                    array[coefficient] *= MathUtils.DoubleSqrt2 / 8;
                
                    if (coefficient == 0)
                    {
                        array[coefficient] *= MathUtils.DoubleInvertedSqrt2;
                    }
                }
