        ...
        */
        ...
        public static ConsoleFont[]? ConsoleFonts
        {
            get
            {
                ...
                return GetConsoleFontInfo(WindowsConsoleUtils.ConsoleOutputHandle, false, (UInt32) fonts.Length, fonts) ? fonts : null;
            }
        }
        ...
        public static UInt32 ConsoleFontIndex
        {
            set
            {
                ...
                SetConsoleFont(WindowsConsoleUtils.ConsoleOutputHandle, value);
            }
        }
        ...
        public static Rectangle Rectangle
        {
            get
            {
                return UserInterfaceUtils.GetWindowRectangle(ConsoleWindow);
            }
        }
        ...
        public static Boolean? IsConsoleVisible
        {
            ...
            set
            {
                ...
                if (value.Value)
                {
                    UserInterfaceUtils.ShowWindow(ConsoleWindow, WindowStateType.Show);
                    return;
                }

                UserInterfaceUtils.ShowWindow(ConsoleWindow, WindowStateType.Hide);
            }
        }
        ...
        public static WindowStateType? ConsoleWindowState
        {
            ...
            set
            {
                ...
                UserInterfaceUtils.ShowWindow(ConsoleWindow, value.Value);
            }
        }
        ...
        public static Boolean? VTCode
        {
            get
            {
                return GetMode(WindowsConsoleUtils.ConsoleOutputHandle, VTProcessing);
            }
            set
            {
                ChangeMode(WindowsConsoleUtils.ConsoleOutputHandle, value, VTProcessing);
            }
        }
        ...
        public static Boolean? IsQuickEditEnabled
        {
            get
            {
                return GetMode(WindowsConsoleUtils.ConsoleInputHandle, QuickEditFlags);
            }
            set
            {
                if (!value.HasValue)
                ...
                if (value.Value)
                {
                    ChangeMode(WindowsConsoleUtils.ConsoleInputHandle, true, QuickEditFlags);
                    return;
                }

                ChangeMode(WindowsConsoleUtils.ConsoleInputHandle, false, QuickEditMode);
            }
        }
        ...
        public static Boolean? IsEchoInputEnabled
        {
            get
            {
                return GetMode(WindowsConsoleUtils.ConsoleInputHandle, EchoInputMode);
            }
            set
            {
                ChangeMode(WindowsConsoleUtils.ConsoleInputHandle, value, EchoInputMode);
            }
        }
        ...
        public static Boolean? IsWindowInputEnabled
        {
            get
            {
                return GetMode(WindowsConsoleUtils.ConsoleInputHandle, WindowInputMode);
            }
            set
            {
                ChangeMode(WindowsConsoleUtils.ConsoleInputHandle, value, WindowInputMode);
            }
        }
        ...
        public static Boolean? IsMouseInputEnabled
        {
            get
            {
                return GetMode(WindowsConsoleUtils.ConsoleInputHandle, MouseInputMode);
            }
            set
            {
                ChangeMode(WindowsConsoleUtils.ConsoleInputHandle, value, MouseInputMode);
            }
        }
