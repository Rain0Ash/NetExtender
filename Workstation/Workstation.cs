...
namespace NetExtender.Workstation
{
    public static class WorkStation
    {
        ...
        public static Task<Boolean> SleepAsync(Int32 milli = 0)
        {
            return SleepAsync(milli, CancellationToken.None);
        }
        
        public static async Task<Boolean> SleepAsync(Int32 milli, CancellationToken token)
        {
            if (milli < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(milli));
        ...
        {
            return HibernateAsync().GetAwaiter().GetResult();
        }
        
        public static Task<Boolean> HibernateAsync(Int32 milli = 0)
        {
            return HibernateAsync(milli, CancellationToken.None);
        }
        
        public static async Task<Boolean> HibernateAsync(Int32 milli, CancellationToken token)
        {
            if (milli < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(milli));
