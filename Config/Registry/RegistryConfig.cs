...
namespace NetExtender.Config.Registry
{
    public sealed class RegistryConfig : Config
    {
        ...
        public RegistryConfig(String path = null, ConfigOptions options = ConfigOptions.None)
        ...
        public RegistryConfig(RegistryKeys key, String path, ConfigOptions options = ConfigOptions.None)
            : base(path, options)
        {
