...
using NetExtender.IO.Files.Lock.Common;
using NetExtender.IO.Files.Lock.Content;
using NetExtender.IO.Files.Lock.Interfaces;

namespace NetExtender.IO.Files.Lock
{
