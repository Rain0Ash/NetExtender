...
namespace NetExtender.StrongId.Diagnostics
{
    ...
    {
        private const String Id = $"{nameof(NetExtender)}.{nameof(StrongId)}.3";
        private const String Title = "Invalid conversion operator";
        private const String Message = $"The {nameof(StrongIdConversionType)} value provided is not a valid combination of flags.";
