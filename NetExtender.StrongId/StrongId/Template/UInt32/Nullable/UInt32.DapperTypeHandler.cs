        ...
        public class DapperTypeHandler : Dapper.SqlMapper.TypeHandler<STRONGID>
        {
            ...
            public override STRONGID Parse(System.Object? value)
            {
                return value switch
                {
                    ...
                    System.SByte result when result >= TYPE.MinValue => new STRONGID((TYPE) result),
                    System.Byte result => new STRONGID(result),
                    System.Int16 result when result >= TYPE.MinValue => new STRONGID((TYPE) result),
                    System.UInt16 result => new STRONGID(result),
                    System.Int32 result when result >= TYPE.MinValue => new STRONGID((TYPE) result),
                    ...
                    _ => throw new System.InvalidCastException($"Unable to cast object of type {value.GetType()} to STRONGID")
                };
            }
        }