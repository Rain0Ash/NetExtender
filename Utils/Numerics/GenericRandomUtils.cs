...
namespace NetExtender.Utils.Numerics
{
    public static partial class RandomUtils
    {
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<SByte> UniqueSetRange<T>([NotNull] T random, SByte min, SByte max) where T : IRandom
		{
			Int32 difference = Math.Min(max.DiscreteIncludeDifference(min, Byte.MaxValue), Int32.MaxValue);
			HashSet<SByte> set = new HashSet<SByte>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<SByte> UniqueSetRange<T>([NotNull] T random, SByte min, SByte max, Int32 count) where T : IRandom
		{
			HashSet<SByte> set = new HashSet<SByte>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<SByte> UniqueShuffleRange<T>([NotNull] T random, SByte min, SByte max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<SByte> UniqueShuffleRange<T>([NotNull] T random, SByte min, SByte max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<SByte> UniqueRange<T>([NotNull] this T random, SByte min, SByte max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<SByte> UniqueRange<T>([NotNull] this T random, SByte min, SByte max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Byte> UniqueSetRange<T>([NotNull] T random, Byte min, Byte max) where T : IRandom
		{
			Int32 difference = Math.Min(max.DiscreteIncludeDifference(min, Byte.MaxValue), Int32.MaxValue);
			HashSet<Byte> set = new HashSet<Byte>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Byte> UniqueSetRange<T>([NotNull] T random, Byte min, Byte max, Int32 count) where T : IRandom
		{
			HashSet<Byte> set = new HashSet<Byte>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Byte> UniqueShuffleRange<T>([NotNull] T random, Byte min, Byte max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Byte> UniqueShuffleRange<T>([NotNull] T random, Byte min, Byte max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<Byte> UniqueRange<T>([NotNull] this T random, Byte min, Byte max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<Byte> UniqueRange<T>([NotNull] this T random, Byte min, Byte max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int16> UniqueSetRange<T>([NotNull] T random, Int16 min, Int16 max) where T : IRandom
		{
			Int32 difference = Math.Min(max.DiscreteIncludeDifference(min, UInt16.MaxValue), Int32.MaxValue);
			HashSet<Int16> set = new HashSet<Int16>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int16> UniqueSetRange<T>([NotNull] T random, Int16 min, Int16 max, Int32 count) where T : IRandom
		{
			HashSet<Int16> set = new HashSet<Int16>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int16> UniqueShuffleRange<T>([NotNull] T random, Int16 min, Int16 max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int16> UniqueShuffleRange<T>([NotNull] T random, Int16 min, Int16 max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<Int16> UniqueRange<T>([NotNull] this T random, Int16 min, Int16 max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<Int16> UniqueRange<T>([NotNull] this T random, Int16 min, Int16 max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt16> UniqueSetRange<T>([NotNull] T random, UInt16 min, UInt16 max) where T : IRandom
		{
			Int32 difference = Math.Min(max.DiscreteIncludeDifference(min, UInt16.MaxValue), Int32.MaxValue);
			HashSet<UInt16> set = new HashSet<UInt16>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt16> UniqueSetRange<T>([NotNull] T random, UInt16 min, UInt16 max, Int32 count) where T : IRandom
		{
			HashSet<UInt16> set = new HashSet<UInt16>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt16> UniqueShuffleRange<T>([NotNull] T random, UInt16 min, UInt16 max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt16> UniqueShuffleRange<T>([NotNull] T random, UInt16 min, UInt16 max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<UInt16> UniqueRange<T>([NotNull] this T random, UInt16 min, UInt16 max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<UInt16> UniqueRange<T>([NotNull] this T random, UInt16 min, UInt16 max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int32> UniqueSetRange<T>([NotNull] T random, Int32 min, Int32 max) where T : IRandom
		{
			Int32 difference = (Int32) Math.Min(max.DiscreteIncludeDifference(min, UInt32.MaxValue), Int32.MaxValue);
			HashSet<Int32> set = new HashSet<Int32>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int32> UniqueSetRange<T>([NotNull] T random, Int32 min, Int32 max, Int32 count) where T : IRandom
		{
			HashSet<Int32> set = new HashSet<Int32>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int32> UniqueShuffleRange<T>([NotNull] T random, Int32 min, Int32 max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int32> UniqueShuffleRange<T>([NotNull] T random, Int32 min, Int32 max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<Int32> UniqueRange<T>([NotNull] this T random, Int32 min, Int32 max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<Int32> UniqueRange<T>([NotNull] this T random, Int32 min, Int32 max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt32> UniqueSetRange<T>([NotNull] T random, UInt32 min, UInt32 max) where T : IRandom
		{
			Int32 difference = (Int32) Math.Min(max.DiscreteIncludeDifference(min, UInt32.MaxValue), Int32.MaxValue);
			HashSet<UInt32> set = new HashSet<UInt32>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt32> UniqueSetRange<T>([NotNull] T random, UInt32 min, UInt32 max, Int32 count) where T : IRandom
		{
			HashSet<UInt32> set = new HashSet<UInt32>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt32> UniqueShuffleRange<T>([NotNull] T random, UInt32 min, UInt32 max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt32> UniqueShuffleRange<T>([NotNull] T random, UInt32 min, UInt32 max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<UInt32> UniqueRange<T>([NotNull] this T random, UInt32 min, UInt32 max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<UInt32> UniqueRange<T>([NotNull] this T random, UInt32 min, UInt32 max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int64> UniqueSetRange<T>([NotNull] T random, Int64 min, Int64 max) where T : IRandom
		{
			Int32 difference = (Int32) Math.Min(max.DiscreteIncludeDifference(min, UInt64.MaxValue), Int32.MaxValue);
			HashSet<Int64> set = new HashSet<Int64>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int64> UniqueSetRange<T>([NotNull] T random, Int64 min, Int64 max, Int32 count) where T : IRandom
		{
			HashSet<Int64> set = new HashSet<Int64>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int64> UniqueShuffleRange<T>([NotNull] T random, Int64 min, Int64 max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Int64> UniqueShuffleRange<T>([NotNull] T random, Int64 min, Int64 max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<Int64> UniqueRange<T>([NotNull] this T random, Int64 min, Int64 max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<Int64> UniqueRange<T>([NotNull] this T random, Int64 min, Int64 max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt64> UniqueSetRange<T>([NotNull] T random, UInt64 min, UInt64 max) where T : IRandom
		{
			Int32 difference = (Int32) Math.Min(max.DiscreteIncludeDifference(min, UInt64.MaxValue), Int32.MaxValue);
			HashSet<UInt64> set = new HashSet<UInt64>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt64> UniqueSetRange<T>([NotNull] T random, UInt64 min, UInt64 max, Int32 count) where T : IRandom
		{
			HashSet<UInt64> set = new HashSet<UInt64>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt64> UniqueShuffleRange<T>([NotNull] T random, UInt64 min, UInt64 max) where T : IRandom
		{
			return MathUtils.RangeInclude(min, max).Shuffle(random);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<UInt64> UniqueShuffleRange<T>([NotNull] T random, UInt64 min, UInt64 max, Int32 count) where T : IRandom
		{
			return UniqueShuffleRange(random, min, max).Take(count);
		}
		...
		public static IEnumerable<UInt64> UniqueRange<T>([NotNull] this T random, UInt64 min, UInt64 max) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		public static IEnumerable<UInt64> UniqueRange<T>([NotNull] this T random, UInt64 min, UInt64 max, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Single> UniqueSetRange<T>([NotNull] T random, Single min, Single max, Byte digits, MidpointRounding rounding) where T : IRandom
		{
			Int32 difference = (Int32) Math.Min(max.DiscreteIncludeDifference(min, digits, Decimal.MaxValue), Int32.MaxValue);
			HashSet<Single> set = new HashSet<Single>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Single> UniqueSetRange<T>([NotNull] T random, Single min, Single max, Byte digits, MidpointRounding rounding, Int32 count) where T : IRandom
		{
			HashSet<Single> set = new HashSet<Single>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Single> UniqueRange<T>([NotNull] this T random, Single min, Single max) where T : IRandom
		{
			return UniqueRange(random, min, max, 0);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Single> UniqueRange<T>([NotNull] this T random, Single min, Single max, Byte digits) where T : IRandom
		{
			return UniqueRange(random, min, max, digits, MathUtils.DefaultRoundType);
		}

		public static IEnumerable<Single> UniqueRange<T>([NotNull] this T random, Single min, Single max, Byte digits, MidpointRounding rounding) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Single> UniqueRange<T>([NotNull] this T random, Single min, Single max, Int32 count) where T : IRandom
		{
			return UniqueRange(random, min, max, 0, count);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Single> UniqueRange<T>([NotNull] this T random, Single min, Single max, Byte digits, Int32 count) where T : IRandom
		{
			return UniqueRange(random, min, max, digits, MathUtils.DefaultRoundType, count);
		}

		public static IEnumerable<Single> UniqueRange<T>([NotNull] this T random, Single min, Single max, Byte digits, MidpointRounding rounding, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Double> UniqueSetRange<T>([NotNull] T random, Double min, Double max, Byte digits, MidpointRounding rounding) where T : IRandom
		{
			Int32 difference = (Int32) Math.Min(max.DiscreteIncludeDifference(min, digits, Decimal.MaxValue), Int32.MaxValue);
			HashSet<Double> set = new HashSet<Double>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Double> UniqueSetRange<T>([NotNull] T random, Double min, Double max, Byte digits, MidpointRounding rounding, Int32 count) where T : IRandom
		{
			HashSet<Double> set = new HashSet<Double>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Double> UniqueRange<T>([NotNull] this T random, Double min, Double max) where T : IRandom
		{
			return UniqueRange(random, min, max, 0);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Double> UniqueRange<T>([NotNull] this T random, Double min, Double max, Byte digits) where T : IRandom
		{
			return UniqueRange(random, min, max, digits, MathUtils.DefaultRoundType);
		}

		public static IEnumerable<Double> UniqueRange<T>([NotNull] this T random, Double min, Double max, Byte digits, MidpointRounding rounding) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Double> UniqueRange<T>([NotNull] this T random, Double min, Double max, Int32 count) where T : IRandom
		{
			return UniqueRange(random, min, max, 0, count);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Double> UniqueRange<T>([NotNull] this T random, Double min, Double max, Byte digits, Int32 count) where T : IRandom
		{
			return UniqueRange(random, min, max, digits, MathUtils.DefaultRoundType, count);
		}

		public static IEnumerable<Double> UniqueRange<T>([NotNull] this T random, Double min, Double max, Byte digits, MidpointRounding rounding, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Decimal> UniqueSetRange<T>([NotNull] T random, Decimal min, Decimal max, Byte digits, MidpointRounding rounding) where T : IRandom
		{
			Int32 difference = (Int32) Math.Min(max.DiscreteIncludeDifference(min, digits, Decimal.MaxValue), Int32.MaxValue);
			HashSet<Decimal> set = new HashSet<Decimal>(Math.Min(difference, Byte.MaxValue));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		private static IEnumerable<Decimal> UniqueSetRange<T>([NotNull] T random, Decimal min, Decimal max, Byte digits, MidpointRounding rounding, Int32 count) where T : IRandom
		{
			HashSet<Decimal> set = new HashSet<Decimal>(count);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Decimal> UniqueRange<T>([NotNull] this T random, Decimal min, Decimal max) where T : IRandom
		{
			return UniqueRange(random, min, max, 0);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Decimal> UniqueRange<T>([NotNull] this T random, Decimal min, Decimal max, Byte digits) where T : IRandom
		{
			return UniqueRange(random, min, max, digits, MathUtils.DefaultRoundType);
		}

		public static IEnumerable<Decimal> UniqueRange<T>([NotNull] this T random, Decimal min, Decimal max, Byte digits, MidpointRounding rounding) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Decimal> UniqueRange<T>([NotNull] this T random, Decimal min, Decimal max, Int32 count) where T : IRandom
		{
			return UniqueRange(random, min, max, 0, count);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEnumerable<Decimal> UniqueRange<T>([NotNull] this T random, Decimal min, Decimal max, Byte digits, Int32 count) where T : IRandom
		{
			return UniqueRange(random, min, max, digits, MathUtils.DefaultRoundType, count);
		}

		public static IEnumerable<Decimal> UniqueRange<T>([NotNull] this T random, Decimal min, Decimal max, Byte digits, MidpointRounding rounding, Int32 count) where T : IRandom
		{
			if (random is null)
			{
				throw new ArgumentNullException(nameof(random));
