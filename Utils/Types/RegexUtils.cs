...
namespace NetExtender.Utils.Types
{
    public static class RegexUtils
    {
        ...
        public static Task<String> JoinMatchesAsync(String str, [RegexPattern] [NotNull] String pattern, String separator, RegexOptions options = RegexOptions.None)
        {
        ...
        public static Task<IEnumerable<String>> IfMatchGetCapturesAsync(this Regex regex, [NotNull] String str)
        {
