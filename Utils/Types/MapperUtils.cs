...
namespace NetExtender.Utils.Types
{
    public static class MapperUtils
    {
        ...
        public static T Map<T>([NotNull] this IMapper mapper, Object value, T alternate)
        {
            if (mapper is null)
            {
        ...
        public static T Map<T>([NotNull] this IMapper mapper, Object value, [NotNull] Func<T> factory)
        {
            if (mapper is null)
            {
                throw new ArgumentNullException(nameof(mapper));
        ...
        public static Boolean TryMap<T>([NotNull] this IMapper mapper, Object value, out T result)
        {
            if (mapper is null)
            {
                throw new ArgumentNullException(nameof(mapper));
        ...
        public static IEnumerable<TMap> MapSelect<T, TMap>([NotNull] this IEnumerable<T> source, [NotNull] IMapper mapper)
        {
            if (source is null)
            {
        ...
        public static IEnumerable<TMap> TryMapSelect<T, TMap>([NotNull] this IEnumerable<T> source, [NotNull] IMapper mapper)
        {
            if (source is null)
            {
                throw new ArgumentNullException(nameof(source));
