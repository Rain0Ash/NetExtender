...
namespace NetExtender.Utils.OS
{
    public static class ProcessUtils
    {
        ...
        public static Process StartProcess([NotNull] String path, Int32 milli = 0)
        {
            return StartProcess(path, milli, CancellationToken.None);
        }
        
        public static Process StartProcess([NotNull] String path, Int32 milli, CancellationToken token)
        {
