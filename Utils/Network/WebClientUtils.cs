...
namespace NetExtender.Utils.Network
{
    public static class WebClientUtils
    {
        ...
        public static Task<FileInfo> DownloadFileTaskAsync(this WebClient client, String address, String path, Byte tries, TimeSpan timeout, Action<Byte> callback,
