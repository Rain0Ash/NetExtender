...
{
    public abstract class AnonymousTypeGeneratorBase : ReflectionTypeGeneratorBase
    {
        protected AnonymousTypeGeneratorBase(String assembly)
            : base(assembly)
        {
        }

        protected AnonymousTypeGeneratorBase(AssemblyName assemblyname, AssemblyBuilder assembly, String modulename, ModuleBuilder module)
