...
namespace NetExtender.Types.Immutable.Dictionaries
{
    ...
    public sealed class ImmutableNullableSortedDictionary<TKey, TValue> : IImmutableDictionary<TKey, TValue>, IDictionary<TKey, TValue>, IDictionary
    {
        ...
        {
            ImmutableSortedDictionary<NullMaybe<TKey>, TValue> @new = pairs is not null ? Internal.AddRange(pairs.KeyNullable()) : Internal;
            return @new != Internal ? Self(@new) : this;
        }
        ...
        {
            ImmutableSortedDictionary<NullMaybe<TKey>, TValue> @new = items is not null ? Internal.SetItems(items.KeyNullable()) : Internal;
            return @new != Internal ? Self(@new) : this;
        }
        ...
        {
            ImmutableSortedDictionary<NullMaybe<TKey>, TValue> @new = keys is not null ? Internal.RemoveRange(keys.Nullable()) : Internal;
            return @new != Internal ? Self(@new) : this;
        }
