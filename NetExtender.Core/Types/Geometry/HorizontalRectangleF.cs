...
namespace NetExtender.Types.Geometry
{
    ...
    public struct HorizontalRectangleF : IReadOnlyCollection<PointF>, IEquatable<RectangleF>, IEquatable<HorizontalRectangleF>, IEquatable<VerticalRectangleF>
    {
        public static implicit operator HorizontalRectangleF(Rectangle value)
        {
            return new HorizontalRectangleF(value);
        }
        public static implicit operator HorizontalRectangleF(RectangleF value)
        {
            return new HorizontalRectangleF(value);
        }
        
        public static implicit operator RectangleF(HorizontalRectangleF value)
        {
            return value.Rectangle;
        }
        
        public static explicit operator Vector4(HorizontalRectangleF value)
        {
            return value.Rectangle.ToVector4();
        }

        public static explicit operator HorizontalRectangleF(Vector4 value)
        {
            return new HorizontalRectangleF(value);
        }

        public static Boolean operator ==(HorizontalRectangleF first, HorizontalRectangleF second)
        {
        ...
        public HorizontalRectangleF(RectangleF rectangle)
        {
            _rectangle = rectangle;
        }
        
        /// <inheritdoc cref="RectangleF(Single,Single,Single,Single)"/>>
        public HorizontalRectangleF(Single x, Single y, Single width, Single height)
        {
            _rectangle = new RectangleF(x, y, width, height);
        }
        
        /// <inheritdoc cref="RectangleF(PointF,SizeF)"/>>
        public HorizontalRectangleF(PointF location, SizeF size)
        {
            _rectangle = new RectangleF(location, size);
        }
        
        /// <inheritdoc cref="RectangleF(Vector4)"/>>
        public HorizontalRectangleF(Vector4 vector)
        {
