...
namespace NetExtender.Types.Geometry
{
    ...
    public struct VerticalRectangle : IReadOnlyCollection<Point>, IEquatable<Rectangle>, IEquatable<VerticalRectangle>, IEquatable<HorizontalRectangle>
    {
        public static implicit operator VerticalRectangle(Rectangle value)
        {
            return new VerticalRectangle(value);
        }
        
        public static implicit operator Rectangle(VerticalRectangle value)
        {
            return value.Rectangle;
        }
        
        public static Boolean operator ==(VerticalRectangle first, VerticalRectangle second)
        {
        ...
        public VerticalRectangle(Rectangle rectangle)
        {
            _rectangle = rectangle;
        }
        
        /// <inheritdoc cref="System.Drawing.Rectangle(Int32,Int32,Int32,Int32)"/>>
        public VerticalRectangle(Int32 x, Int32 y, Int32 width, Int32 height)
        {
            _rectangle = new Rectangle(x, y, width, height);
        }
        
        /// <inheritdoc cref="System.Drawing.Rectangle(Point,System.Drawing.Size)"/>>
        public VerticalRectangle(Point location, Size size)
        {
