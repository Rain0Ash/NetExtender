...
{
    public readonly struct TwoWayReadOnlyLinkedListNode<T> : ILinkedListNode<T>, IEnumerable<TwoWayReadOnlyLinkedListNode<T>>, IEnumerable<ILinkedListNode<T>>, IStruct<TwoWayReadOnlyLinkedListNode<T>>
    {
