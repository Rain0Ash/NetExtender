...
namespace NetExtender.Interfaces
{
    ...
    public interface IInheritNumericUtf8SpanParsable<TSelf> : INetExtenderNumericUtf8SpanParsable<TSelf>, IInheritUtf8SpanParsable<TSelf>
#if NET8_0_OR_GREATER
        where TSelf : IInheritNumericUtf8SpanParsable<TSelf>?
#endif
    {
        public new const NumericsInterfaceGroup Group = INetExtenderNumericUtf8SpanParsable<TSelf>.Group | IInheritUtf8SpanParsable<TSelf>.Group;
        ...
        public new static Boolean IsSupported
        {
            ...
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericUtf8SpanParsable<TSelf>, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set>.IsSupported;
            }
        }

        protected internal new static INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler Handler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericUtf8SpanParsable<TSelf>, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set>.Handler;
            }
        }

        protected internal new static INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler SafeHandler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericUtf8SpanParsable<TSelf>, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set>.SafeHandler;
            }
        }

        protected internal new static INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set Storage
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericUtf8SpanParsable<TSelf>, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set>.Storage;
            }
        }
        ...
        {
            return INetExtenderOperator<TSelf, INetExtenderNumericUtf8SpanParsable<TSelf>, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set>.Ensure();
        }
        ...
        INetExtenderOperator<TSelf, INetExtenderNumericUtf8SpanParsable<TSelf>, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set>
    {
        ...
        public new sealed class OperatorHandler : INetExtenderOperator.OperatorHandler<TSelf, INetExtenderNumericUtf8SpanParsable<TSelf>, INetExtenderNumericUtf8SpanParsable<TSelf>.OperatorHandler.Set>
        {
            ...
            protected override IEnumerable<Result<INetExtenderOperator.OperatorHandler>> Initialize(Set set)
            {
                ...
                Utf8StyleParseHandler<TSelf>? uparse = Initialize<Utf8StyleParseHandler<TSelf>>(this, Parse);
                Utf8NumericParseHandler<TSelf>? unparse = Initialize<Utf8NumericParseHandler<TSelf>>(this, Parse);
                Utf8StyleTryParseHandler<TSelf>? utparse = Initialize<Utf8StyleTryParseHandler<TSelf>>(this, TryParse);
                Utf8NumericTryParseHandler<TSelf>? untparse = Initialize<Utf8NumericTryParseHandler<TSelf>>(this, TryParse);
