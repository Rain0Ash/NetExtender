...
namespace NetExtender.Interfaces
{
...
#endif
    {
        ...
        public new sealed class OperatorHandler : INetExtenderOperator.OperatorHandler<TSelf, INetExtenderUtf8SpanParsable<TSelf>, INetExtenderUtf8SpanParsable<TSelf>.OperatorHandler.Set>
        {
            ...
            {
                Utf8ParseHandler<TSelf>? uparse = Method<Utf8ParseHandler<TSelf>>(this, Parse);
                Utf8FormatParseHandler<TSelf>? ufparse = Method<Utf8FormatParseHandler<TSelf>>(this, Parse);
                Utf8TryParseHandler<TSelf>? utparse = Method<Utf8TryParseHandler<TSelf>>(this, TryParse);
                Utf8FormatTryParseHandler<TSelf>? uftparse = Method<Utf8FormatTryParseHandler<TSelf>>(this, TryParse);
