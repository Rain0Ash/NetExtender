...
namespace NetExtender.Interfaces
{
    ...
    public interface IInheritNumericSpanParsable<TSelf> : INetExtenderNumericSpanParsable<TSelf>, IInheritSpanParsable<TSelf>
#if NET7_0_OR_GREATER
        where TSelf : IInheritNumericSpanParsable<TSelf>?
#endif
    {
        public new const NumericsInterfaceGroup Group = INetExtenderNumericSpanParsable<TSelf>.Group | IInheritSpanParsable<TSelf>.Group;
        ...
        public new static Boolean IsSupported
        {
            ...
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericSpanParsable<TSelf>, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set>.IsSupported;
            }
        }

        protected internal new static INetExtenderNumericSpanParsable<TSelf>.OperatorHandler Handler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericSpanParsable<TSelf>, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set>.Handler;
            }
        }

        protected internal new static INetExtenderNumericSpanParsable<TSelf>.OperatorHandler SafeHandler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericSpanParsable<TSelf>, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set>.SafeHandler;
            }
        }

        protected internal new static INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set Storage
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumericSpanParsable<TSelf>, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set>.Storage;
            }
        }
        ...
        {
            return INetExtenderOperator<TSelf, INetExtenderNumericSpanParsable<TSelf>, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set>.Ensure();
        }
        ...
        INetExtenderOperator<TSelf, INetExtenderNumericSpanParsable<TSelf>, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set>
    {
        ...
        public new sealed class OperatorHandler : INetExtenderOperator.OperatorHandler<TSelf, INetExtenderNumericSpanParsable<TSelf>, INetExtenderNumericSpanParsable<TSelf>.OperatorHandler.Set>
        {
            ...
            protected override IEnumerable<Result<INetExtenderOperator.OperatorHandler>> Initialize(Set set)
            {
                ...
                StyleParseHandler<TSelf>? parse = Initialize<StyleParseHandler<TSelf>>(this, Parse);
                NumericParseHandler<TSelf>? fparse = Initialize<NumericParseHandler<TSelf>>(this, Parse);
                StyleTryParseHandler<TSelf>? tparse = Initialize<StyleTryParseHandler<TSelf>>(this, TryParse);
                NumericTryParseHandler<TSelf>? ftparse = Initialize<NumericTryParseHandler<TSelf>>(this, TryParse);
