...
namespace NetExtender.Utilities.Types
{
    public static class SetUtilities
    {
        ...
        public static Boolean AddIfNotNull<T>(this HashSet<T> set, T? item)
        {
            if (set is null)
            {
                throw new ArgumentNullException(nameof(set));
            ...
            return item is not null && set.Add(item);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolean AddIfNotNull<T>(this HashSet<T> set, T? item) where T : struct
        {
            if (set is null)
            {
                throw new ArgumentNullException(nameof(set));
            ...
            return item.HasValue && set.Add(item.Value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolean AddIfNotNull<T>(this SortedSet<T> set, T? item)
        {
            if (set is null)
            {
                throw new ArgumentNullException(nameof(set));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolean AddIfNotNull<T>(this SortedSet<T> set, T? item) where T : struct
        {
            if (set is null)
            {
                throw new ArgumentNullException(nameof(set));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolean AddIfNotNull<T>(this ISet<T> set, T? item)
        {
            if (set is null)
            {
                throw new ArgumentNullException(nameof(set));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolean AddIfNotNull<T>(this ISet<T> set, T? item) where T : struct
        {
            if (set is null)
            {
                throw new ArgumentNullException(nameof(set));
