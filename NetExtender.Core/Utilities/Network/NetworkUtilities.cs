...
namespace NetExtender.Utilities.Network
{
    ...
    public static class NetworkUtilities
    {
        ...
        public static UInt16 GeneratePort(this PortType type)
        {
            ...
            {
                PortType.Invalid => 0,
                PortType.System => RandomUtilities.Next(1, 1023),
                PortType.Register => RandomUtilities.Next(1024, 49151),
                PortType.Dynamic => RandomUtilities.Next(49152, 65535),
                _ => throw new NotSupportedException()
            });
        }
        ...
        {
            return EnumerableUtilities.GetEnumerableFrom(() => GeneratePort(type)).Distinct().Where(IsPortAvailable);
        }
