...
{
    public class IndexDictionary<TKey, TValue> : IIndexDictionary<TKey, TValue>, IReadOnlyIndexDictionary<TKey, TValue>
    {
        ...
        public IndexDictionary([JetBrains.Annotations.NotNull] IDictionary<TKey, TValue> dictionary)
        {
        ...
        public IndexDictionary([JetBrains.Annotations.NotNull] IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer)
        {
            if (dictionary is null)
            {
                throw new ArgumentNullException(nameof(dictionary));
        ...
        public void Add([JetBrains.Annotations.NotNull] TKey key, TValue value)
        {
            if (key is null)
            {
        ...
        public Boolean TryAdd([JetBrains.Annotations.NotNull] TKey key, TValue value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        public void Insert(Int32 index, [JetBrains.Annotations.NotNull] TKey key, TValue value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        {
            (TKey key, TValue value) = item;
            if (_dictionary.TryGetValue(key, out TValue result) && result.Equals(value))
            {
                return Remove(key);
            }
