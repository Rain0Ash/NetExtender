...
{
    [Serializable]
    public class MultiDictionary<TKey, TValue> : Dictionary<TKey, ImmutableHashSet<TValue>>, IMultiDictionary<TKey, TValue>, IReadOnlyMultiDictionary<TKey, TValue>
    {
        ...
        TValue IDictionary<TKey, TValue>.this[[NotNull] TKey key]
        {
            get
            {
                if (key is null)
