...
namespace NetExtender.Types.Queues
{
    public class TaskQueue
    {
        ...
        private TaskCompletionSource<Boolean> _tscQueue = new TaskCompletionSource<Boolean>();
        ...
        {
            Task.Run(ProcessAsync).ContinueWith(t => { exception?.Invoke(t.Exception); }, TaskContinuationOptions.OnlyOnFaulted);
        }
        ...
        private void StartTasks()
        {
            ...
            TaskCompletionSource<Boolean> oldQueue = Interlocked.Exchange(
                ref _tscQueue, new TaskCompletionSource<Boolean>());
