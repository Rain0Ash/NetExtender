...
namespace NetExtender.Types.Strings
{
    public sealed class StringBuilderAdapter : StringBase, IString, IEquatable<StringBuilder>
    {
        ...
        private static IString[] SplitConversion([NotNull] IEnumerable<StringBuilder> builders)
        {
            // ReSharper disable once CoVariantArrayConversion
            return builders.Select(builder => new StringBuilderAdapter(builder)).ToArray();
        }
