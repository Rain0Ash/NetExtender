...
{
    public interface IString : IReactiveObject, IComparable, IConvertible, IEnumerable<Char>, IComparable<String?>, IEquatable<String?>, IComparable<IString?>, IEquatable<IString?>, ICloneable
    {
        /// <summary>
