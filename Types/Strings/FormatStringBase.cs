...
namespace NetExtender.Types.Strings
{
    public abstract class FormatStringBase : StringBase, IFormatString
    {
        ...
        public virtual String Format([CanBeNull] IFormatProvider? provider, params Object[] format)
        {
            if (Arguments <= 0)
            {
        ...
        protected String NonFormatToString([CanBeNull] IFormatProvider? provider)
        {
