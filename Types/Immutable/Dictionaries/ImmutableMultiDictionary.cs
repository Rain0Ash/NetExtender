...
{
    public sealed class ImmutableMultiDictionary<TKey, TValue> : IImmutableMultiDictionary<TKey, TValue>
    {
        ...
        public Boolean TryGetValue([NotNull] TKey key, out ImmutableHashSet<TValue> value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        public Boolean TryGetKey([NotNull] TKey equalKey, out TKey actualKey)
        {
            if (equalKey is null)
            {
        ...
        public ImmutableMultiDictionary<TKey, TValue> Add([NotNull] TKey key, ImmutableHashSet<TValue> value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.Add([NotNull] TKey key, ImmutableHashSet<TValue> value)
        {
            return Add(key, value);
        }

        public ImmutableMultiDictionary<TKey, TValue> AddRange([NotNull] IEnumerable<KeyValuePair<TKey, ImmutableHashSet<TValue>>> pairs)
        {
            if (pairs is null)
            {
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.AddRange([NotNull] IEnumerable<KeyValuePair<TKey, ImmutableHashSet<TValue>>> pairs)
        {
            return AddRange(pairs);
        }

        public ImmutableMultiDictionary<TKey, TValue> SetItem([NotNull] TKey key, ImmutableHashSet<TValue> value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.SetItem([NotNull] TKey key, ImmutableHashSet<TValue> value)
        {
            return SetItem(key, value);
        }

        public ImmutableMultiDictionary<TKey, TValue> SetItems([NotNull] IEnumerable<KeyValuePair<TKey, ImmutableHashSet<TValue>>> items)
        {
            if (items is null)
            {
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.SetItems([NotNull] IEnumerable<KeyValuePair<TKey, ImmutableHashSet<TValue>>> items)
        {
            return SetItems(items);
        }
        
        public ImmutableMultiDictionary<TKey, TValue> Remove([NotNull] TKey key, ImmutableHashSet<TValue> value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.Remove([NotNull] TKey key, ImmutableHashSet<TValue> value)
        {
            return Remove(key, value);
        }
        
        public ImmutableMultiDictionary<TKey, TValue> Remove([NotNull] TKey key)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.Remove([NotNull] TKey key)
        {
            return Remove(key);
        }

        public ImmutableMultiDictionary<TKey, TValue> Remove([NotNull] TKey key, TValue value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.Remove([NotNull] TKey key, TValue value)
        {
            return Remove(key, value);
        }

        public ImmutableMultiDictionary<TKey, TValue> RemoveRange([NotNull] IEnumerable<TKey> keys)
        {
            if (keys is null)
            {
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.RemoveRange([NotNull] IEnumerable<TKey> keys)
        {
        ...
        public IImmutableMultiDictionary<TKey, TValue> AddRange([NotNull] IEnumerable<KeyValuePair<TKey, TValue>> pairs)
        {
            if (pairs is null)
            {
                throw new ArgumentNullException(nameof(pairs));
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.AddRange([NotNull] IEnumerable<KeyValuePair<TKey, TValue>> pairs)
        {
            return AddRange(pairs);
        }
        ...
        public ImmutableMultiDictionary<TKey, TValue> SetItems([NotNull] IEnumerable<KeyValuePair<TKey, TValue>> items)
        {
            if (items is null)
            {
                throw new ArgumentNullException(nameof(items));
        ...
        IImmutableMultiDictionary<TKey, TValue> IImmutableMultiDictionary<TKey, TValue>.SetItems([NotNull] IEnumerable<KeyValuePair<TKey, TValue>> items)
        {
            return SetItems(items);
        }
        ...
        TValue IReadOnlyDictionary<TKey, TValue>.this[[NotNull] TKey key]
        {
            get
            {
                if (key is null)
