...
namespace NetExtender.Types.Concurrent.Counters
{
    public class ConcurrentCounter<T> : ICounter<T>, IReadOnlyCounter<T> where T : notnull
    {
        ...
        public ConcurrentCounter([NotNull] IEnumerable<T> collection, IEqualityComparer<T>? comparer)
        {
            if (collection is null)
            {
                throw new ArgumentNullException(nameof(collection));
        ...
        public ConcurrentCounter(Int32 concurrencyLevel, [NotNull] IEnumerable<T> collection, IEqualityComparer<T>? comparer)
        {
            if (collection is null)
            {
                throw new ArgumentNullException(nameof(collection));
        ...
        public Boolean TryGetValue([NotNull] T key, out Int32 value)
        {
            if (key is null)
            {
                throw new ArgumentNullException(nameof(key));
        ...
        public Int32 Add([NotNull] T item)
        {
            if (item is null)
            {
        ...
        public Boolean TryAdd([NotNull] T item)
        {
            return TryAdd(item, out _);
        }

        public Boolean TryAdd([NotNull] T item, out Int32 count)
        {
            if (item is null)
            {
                throw new ArgumentNullException(nameof(item));
        ...
        public void AddRange([NotNull] IEnumerable<T> source)
        {
            if (source is null)
            {
        ...
        public Boolean Remove([NotNull] T item, out Int32 count)
        {
            if (item is null)
            {
                throw new ArgumentNullException(nameof(item));
        ...
        public void RemoveRange([NotNull] IEnumerable<T> source)
        {
            if (source is null)
            {
                throw new ArgumentNullException(nameof(source));
