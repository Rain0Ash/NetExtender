...
namespace NetExtender.Localizations
{
    ...
    public class LocaleMultiString : MultiString
    {
        ...
        public LocaleMultiString()
            : this(0)
        {
        }

        public LocaleMultiString([NotNull] String @default)
            : this(@default.FormatArgsExpected(), @default)
        {
        }

        public LocaleMultiString(Int32 args = 0, [NotNull] String @default = StringMissing)
        {
