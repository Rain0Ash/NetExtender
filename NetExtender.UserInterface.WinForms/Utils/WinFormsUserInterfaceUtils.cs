...
{
    public static class WinFormsUserInterfaceUtils
    {
        ...
        public static Rectangle GetWindowRectangle(this Form form)
        {
            ...
            return UserInterfaceUtils.GetWindowRectangle(form.Handle);
        }
        ...
        public static Boolean ShowWindow(this Form form, WindowStateType state)
        {
            ...
            return UserInterfaceUtils.ShowWindow(form.Handle, state);
        }
        ...
        public static Boolean BringToForeground(this Form form)
        {
            ...
            return UserInterfaceUtils.BringToForegroundWindow(form.Handle);
        }
