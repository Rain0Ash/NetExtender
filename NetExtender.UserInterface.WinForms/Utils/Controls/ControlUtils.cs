...
namespace NetExtender.Utils.UserInterface.WinForms.Controls
{
    ...
    public static class ControlUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T SetPosition<T>(this T control, Control relative, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            return SetPosition(control, relative, PointOffset.Right, distance);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T SetPosition<T>(this T control, Control relative, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            return SetPosition(control, relative, PointOffset.Right, alignment, distance);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T SetPosition<T>(this T control, Control relative, PointOffset offset, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static T SetPosition<T>(this T control, Control relative, PointOffset offset, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T SetPositionInner<T>(this T control, Control relative, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T SetPositionInner<T>(this T control, Control relative, PointOffset offset, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T SetPositionOuter<T>(this T control, Control relative, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            return SetPositionOuter(control, relative, PointOffset.Right, distance);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T SetPositionOuter<T>(this T control, Control relative, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            return SetPositionOuter(control, relative, PointOffset.Right, alignment, distance);
        }

        public static T SetPositionOuter<T>(this T control, Control relative, PointOffset offset, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static T SetPositionOuter<T>(this T control, Control relative, PointOffset offset, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance) where T : Control
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionTo(this Control control, Control relative, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionTo(this Control control, Control relative, PointOffset offset, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionTo(this Control control, Control relative, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionTo(this Control control, Control relative, PointOffset offset, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionInnerTo(this Control control, Control relative, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionInnerTo(this Control control, Control relative, PointOffset offset, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionOuterTo(this Control control, Control relative, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionOuterTo(this Control control, Control relative, PointOffset offset, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionOuterTo(this Control control, Control relative, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
        ...
        public static IDisposable BindPositionOuterTo(this Control control, Control relative, PointOffset offset, HorizontalAlignment alignment, Int32 distance = UserInterfaceUtils.Distance)
        {
            if (control is null)
            {
                throw new ArgumentNullException(nameof(control));
