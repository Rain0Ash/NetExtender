...
namespace NetExtender.Network.Type
{
    public class Client : INetBase
    {
        ...
        private void StartConnect()
        {
            ...
            SocketAsyncEventArgs connectEventArg = new SocketAsyncEventArgs {RemoteEndPoint = _remoteEndPoint};
            connectEventArg.Completed += AcceptEventArg_Completed;
            Boolean willRaiseEvent = _connectSocket.ConnectAsync(connectEventArg);
            if (!willRaiseEvent)
            {
