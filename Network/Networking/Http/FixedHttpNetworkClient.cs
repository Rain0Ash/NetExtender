...
namespace NetExtender.Network.Networking.Http
{
    ...
    public class FixedHttpNetworkClient : HttpNetworkClient
    {
        // Disposed flag.
        ...
        public FixedHttpNetworkClient(IPAddress address, Int32 port)
            : base(address, port)
        {
        }
        ...
        /// <param name="address">IP address</param>
        /// <param name="port">Port number</param>
        public FixedHttpNetworkClient(String address, Int32 port)
            : base(address, port)
        {
        }
        ...
        public FixedHttpNetworkClient(IPEndPoint endpoint)
            : base(endpoint)
        {
        }
