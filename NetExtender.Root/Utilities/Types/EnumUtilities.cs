...
namespace NetExtender.Utilities.Types
{
    public static partial class EnumUtilities
    {
        ...
        {
            return ListBaseUtilities.GetRandom(EnumStorage<T>.Get<TEnum>());
        }
        ...
        public static T GetRandomEnumValue<T>(this IEnumerable<T> source) where T : unmanaged, Enum
        {
            ...
            if (count is null)
            {
                return ListBaseUtilities.GetRandom(source.ToArray());
            }

            return count > 0 ? EnumerableBaseUtilities.GetRandom(source) : Random<T>();
        }
