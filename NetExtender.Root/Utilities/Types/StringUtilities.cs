...
namespace NetExtender.Utilities.Types
{
    ...
    public static partial class StringUtilities
    {
        ...
        private static String[] NewLineWhiteSpace { get; } = NewLine.Concat(WhiteSpace.Select(Char.ToString)).Distinct().ToArray();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(T value, Span<Char> destination, out Int32 written)
        {
            return TryFormat(value, destination, out written, null, null);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(in T value, Span<Char> destination, out Int32 written)
        {
            return TryFormat(in value, destination, out written, null, null);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(T value, Span<Char> destination, out Int32 written, String? format)
        {
            return TryFormat(value, destination, out written, format, null);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(in T value, Span<Char> destination, out Int32 written, String? format)
        {
            return TryFormat(in value, destination, out written, format, null);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(T value, Span<Char> destination, out Int32 written, IFormatProvider? provider)
        {
            return TryFormat(value, destination, out written, null, provider);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(in T value, Span<Char> destination, out Int32 written, IFormatProvider? provider)
        {
            return TryFormat(in value, destination, out written, null, provider);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(T value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider)
        {
            return TryFormat(in value, destination, out written, format, provider);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static String? TryFormat<T>(in T value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider)
        {
            return SpanFormattable.TryFormat(in value, destination, out written, format, provider);
        }
        ...
        public static IEnumerable<String?> ToStringEnumerable<T>(this IEnumerable<T> source, String? format)
        {
            ...
            {
                yield return ToString(item, format);
            }
        }
        ...
        public static IEnumerable<String?> ToStringEnumerable<T>(this IEnumerable<T> source, IFormatProvider? provider)
        {
            ...
            foreach (T item in source)
            {
                yield return ToString(item, provider);
            }
        }
        ...
        public static IEnumerable<String?> ToStringEnumerable<T>(this IEnumerable<T> source, String? format, IFormatProvider? provider)
        {
            ...
            foreach (T item in source)
            {
                yield return ToString(item, format, provider);
            }
        }
        ...
        public static Int32 CharLength(this String?[] values)
        {
            ...
            return values.Length switch
            {
                0 => 0,
                1 => values[0]?.Length ?? 0,
                _ => EnumerableBaseUtilities.WhereNotNull(values).Sum(static item => item.Length)
            };
        }
        ...
        public static Int32 CharLength(this IEnumerable<String?> values)
        {
            ...
            return EnumerableBaseUtilities.WhereNotNull(values).Sum(static item => item.Length);
        }
        ...
        public static Int32 CharLength(this IEnumerable<IString?> values)
        {
            ...
            return EnumerableBaseUtilities.WhereNotNull(values).Sum(static value => value.Length);
        }
        ...
        public static Int64 CharLongLength(this String?[] values)
        {
            ...
            return values.Length switch
            {
                0 => 0,
                1 => values[0]?.Length ?? 0,
                _ => EnumerableBaseUtilities.WhereNotNull(values).Aggregate<String, Int64>(0, static (current, item) => current + item.Length)
            };
        }
        ...
        public static Int64 CharLongLength(this IEnumerable<String?> values)
        {
            ...
            return EnumerableBaseUtilities.WhereNotNull(values).Aggregate<String, Int64>(0, static (current, item) => current + item.Length);
        }
        ...
        public static Int64 CharLongLength(this IString?[] values)
        {
            ...
            return values.Length switch
            {
                0 => 0,
                1 => values[0]?.Length ?? 0,
                _ => EnumerableBaseUtilities.WhereNotNull(values).Aggregate<IString, Int64>(0, static (current, item) => current + item.Length)
            };
        }
        ...
        public static Int64 CharLongLength(this IEnumerable<IString?> values)
        {
            ...
            return EnumerableBaseUtilities.WhereNotNull(values).Aggregate<IString, Int64>(0, static (current, item) => current + item.Length);
        }
        ...
        public static IEnumerable<String> GetFormatVariables(String value)
        {
            ...
            return Regex.Matches(value, FormatVariableRegexPattern, RegexOptions.Compiled)
                ...
                .Select(static format => FormatVariablesRegex.Remove(format.ToLower()));
        }
        ...
        public static String ReplaceFrom<T>(this String source, IEnumerable<KeyValuePair<String, T?>> dictionary)
        {
            ...
            return ReplaceFrom(source, dictionary.Select(static pair => new KeyValuePair<String, String?>(pair.Key, pair.Value?.ToString())));
        }
        ...
        public static String FormatFrom<T>(this String value, IEnumerable<KeyValuePair<String, T?>> source)
        {
            ...
            Int32 index = 0;
            foreach ((String key, T? item) in source)
            {
                if (item is null || !keys.Add(key))
                {
                    continue;
                }

                builder.Replace("{" + key + "}", "{" + index + "}");

                arguments.Add(item);
                index++;
            }

            return String.Format(builder.ToString(), arguments.ToArray());
        }
        ...
        public static Int32 CountExpectedFormatArguments(this String value)
        {
            ...
            return matches.Select(static match => match.Value).Distinct().Count();
        }
        ...
        public static Boolean StartsWith(this String value, IEnumerable<String?> substrings)
        {
            ...
            {
                if (item is not null && value.StartsWith(item))
                {
                    return true;
                }
            }
        ...
        public static Boolean StartsWith(this String value, IEnumerable<String?> substrings, StringComparison comparison)
        {
            ...
            foreach (String? item in substrings)
            {
                if (item is not null && value.StartsWith(item, comparison))
                {
                    return true;
                }
            }
        ...
        public static Boolean EndsWith(this String value, IEnumerable<String?> substrings)
        {
            ...
            foreach (String? item in substrings)
            {
                if (item is not null && value.EndsWith(item))
                {
                    return true;
                }
            }
        ...
        public static Boolean EndsWith(this String value, IEnumerable<String?> substrings, StringComparison comparison)
        {
            ...
            foreach (String? item in substrings)
            {
                if (item is not null && value.EndsWith(item, comparison))
                {
                    return true;
                }
            }
        ...
        public static Boolean IsAsciiCharacters(this String value)
        {
            ...
            return value.Length <= 0 || value.All(static character => character >= 0x20 && character <= Byte.MaxValue);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static String[] SplitByUpperCase(IEnumerable<String?> source)
        {
            return SplitByUpperCase(source, StringSplitOptions.RemoveEmptyEntries);
        }

        private static String[] SplitByUpperCase(IEnumerable<String?> source, StringSplitOptions options)
        {
            if (source is null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            foreach (String? value in source)
            {
                ...
                String[] split = SplitByUpperCase(value, options);
        ...
        public static String Concat(this IEnumerable<Char> source)
        {
            ...
            return source as String ?? source.ToStringBuilder().ToString();
        }
        ...
        public static IEnumerable<IString> WhereNotNullOrEmpty(this IEnumerable<IString?> source)
        {
            ...
            foreach (IString? item in source)
            {
        ...
        public static String Shuffle(this String value)
        {
            ...
            return value.Length > 1 ? EnumerableBaseUtilities.Shuffle(value).Join() : value;
        }
        ...
        public static String WhereNotChar(this String value, Func<Char, Boolean> where)
        {
            ...
            return value.Length > 0 ? String.Join(String.Empty, EnumerableBaseUtilities.WhereNot(value, where)) : String.Empty;
        }
        ...
        public static String RemoveDiacritics(this String value)
        {
            ...
            foreach (Char character in normalize.Where(static character => CharUnicodeInfo.GetUnicodeCategory(character) != UnicodeCategory.NonSpacingMark))
            {
                builder.Append(character);
            }
        ...
        public static IEnumerable<Char32> EnumerateUnicode(this String value)
        {
            ...
            return value.EnumerateRunes().Select(static item => (Char32) item);
        }
#endif
    ...
    public static partial class StringUtilities
    {
        ...
        [SuppressMessage("ReSharper", "MemberHidesStaticFromOuterClass")]
        private static class SpanFormattable
        {
            private static class StructStorage<T> where T : struct
            {
                [SuppressMessage("ReSharper", "UnusedParameter.Local")]
                public static String? TryFormat(ref T value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider)
                {
                    String? result = value.ToString();

                    if (result is not null && result.TryCopyTo(destination))
                    {
            ...
            private static class StructFormattableStorage<T> where T : struct, IFormattable
            {
                public static String? TryFormat(ref T value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider)
                {
                    String result = value.ToString(format, provider);
            ...
            private static class StructSpanFormattableStorage<T> where T : struct, ISpanFormattable
            {
                public static String? TryFormat(ref T value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider)
                {
                    if (value.TryFormat(destination, out written, format, provider))
                    {
                        return null;
                    }
            ...
            private static class Storage<T>
            {
                private delegate String? FormatDelegate(ref T value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider);
                private static FormatDelegate? Format { get; }
                ...
                static Storage()
                {
                    ...
                    Type selector = typeof(T).HasInterface<ISpanFormattable>() ? typeof(StructSpanFormattableStorage<>) : typeof(T).HasInterface<IFormattable>() ? typeof(StructFormattableStorage<>) : typeof(StructStorage<>);
                    selector = selector.MakeGenericType(typeof(T));

                    MethodInfo method = selector.GetMethod(nameof(TryFormat), new[] { typeof(T).MakeByRefType(), typeof(Span<Char>), typeof(Int32).MakeByRefType(), typeof(String), typeof(IFormatProvider) }) ?? throw new NeverOperationException();
                    Format = (FormatDelegate) method.CreateDelegate(typeof(FormatDelegate));
                }
                ...
                public static String? TryFormat(ref T? value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider)
                {
                    ...
                    {
                        return Format.Invoke(ref value, destination, out written, format, provider);
                    }

                    switch (value)
                    {
                        case ISpanFormattable formattable when formattable.TryFormat(destination, out written, format, provider):
                        {
                            return null;
                        }
            ...
            public static String? TryFormat<T>(in T? value, Span<Char> destination, out Int32 written, String? format, IFormatProvider? provider)
            {
                return Storage<T>.TryFormat(ref Unsafe.AsRef(in value), destination, out written, format, provider);
            }
        }
    }
}