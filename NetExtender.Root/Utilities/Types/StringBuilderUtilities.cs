    ...
    public static class StringBuilderUtilities
    {
        ...
        public static StringBuilder AddSuffix(this StringBuilder builder, params String[]? values)
        {
            ...
            switch (values.Length)
            {
                ...
                default:
                    Int32 length = builder.Length + EnumerableBaseUtilities.WhereNotNull(values).Sum(static value => value.Length);
                    return length <= builder.MaxCapacity ? values.Aggregate(builder, static (builder, value) => builder.Append(value)) : throw new ArgumentOutOfRangeException(nameof(values), values.Length, null);
            }
        }
        ...
        public static StringBuilder TrimStart(this StringBuilder builder, Func<Char, Boolean> predicate)
        {
            ...
            return count > 0 ? builder.Remove(0, count) : builder;
        }
