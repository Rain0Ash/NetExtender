...
namespace NetExtender.Utilities.Types
{
    public static class ResultUtilities
    {
        ...
        [StackTraceHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static async ValueTask Throw(this Async async)
        {
            Result<Unit> result = await async;
            result.Throw();
        }

        [StackTraceHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static async ValueTask<T> Throw<T>(this Async<T> async)
        {
            return await async;
        }
        ...
        [StackTraceHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static async ValueTask Throw(this BusinessAsync async)
        {
            BusinessResult result = await async;
            result.Throw();
        }

        [StackTraceHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static async ValueTask<T> Throw<T>(this BusinessAsync<T> async)
        {
            return await async;
        }
        ...
        public static Exception? Exception<T>(params Result<T>[]? result)
        {
            ...
            return result.Length switch
            {
                ...
                _ => EnumerableBaseUtilities.WhereNotNull(result.Select(static result => result.Exception)).ToArray() switch
                {
                    { Length: 0 } => null,
        ...
        public static Exception? Exception<T, TException>(params Result<T, TException>[]? result) where TException : Exception
        {
            ...
            return result.Length switch
            {
                ...
                4 => Exception(result[0], result[1], result[2], result[3]),
                5 => Exception(result[0], result[1], result[2], result[3], result[4]),
                _ => EnumerableBaseUtilities.WhereNotNull(result.Select(static Exception? (result) => result.Exception)).ToArray() switch
                {
                    { Length: 0 } => null,
                    { Length: 1 } array => array[0],
                    { } array => ExceptionUtilities.FastAggregate(array)
        ...
        {
            return value && exception is not null ? exception.Throwable() : value;
        }
        ...
        {
            return value && exception?.Invoke() is { } result ? result.Throwable() : value;
        }
        ...
        {
            return value && exception?.Invoke(value) is { } result ? result.Throwable() : value;
        }
        ...
        {
            return value && exception is not null ? exception.Throwable() : new Result<T, TException>(value);
        }
        ...
        {
            return value && exception?.Invoke() is { } result ? result.Throwable() : new Result<T, TException>(value);
        }
        ...
        {
            return value && exception?.Invoke(value) is { } result ? result.Throwable() : new Result<T, TException>(value);
        }
        ...
        {
            return value && exception is not null ? exception.Throwable() : new BusinessResult<T>(value);
        }
        ...
        {
            return value && exception?.Invoke() is { } result ? result.Throwable() : new BusinessResult<T>(value);
        }
        ...
        {
            return value && exception?.Invoke(value) is { } result ? result.Throwable() : new BusinessResult<T>(value);
        }
        ...
        {
            return value && exception is not null ? exception.Throwable() : new BusinessResult<T, TBusiness>(value);
        }
        ...
        {
            return value && exception?.Invoke() is { } result ? result.Throwable() : new BusinessResult<T, TBusiness>(value);
        }
        ...
        {
            return value && exception?.Invoke(value) is { } result ? result.Throwable() : new BusinessResult<T, TBusiness>(value);
        }
        ...
        {
            return value && exception is not null ? exception.Throwable() : new Result<T, TBusiness>(value);
        }
        ...
        {
            return value && exception?.Invoke() is { } result ? result.Throwable() : new Result<T, TBusiness>(value);
        }
        ...
        {
            return value && exception?.Invoke(value) is { } result ? result.Throwable() : new Result<T, TBusiness>(value);
        }
