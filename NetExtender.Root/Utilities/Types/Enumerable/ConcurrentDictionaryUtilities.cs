...
namespace NetExtender.Utilities.Types
{
    ...
    {
        public static TValue GetOrNew<TKey, TValue>(this ConcurrentDictionary<TKey, TValue> dictionary, TKey key) where TKey : notnull where TValue : new()
        {
            ...
            return dictionary.GetOrAdd(key, static _ => new TValue());
        }
        ...
        public static Boolean TryGetOrAdd<TKey, TValue>(this ConcurrentDictionary<TKey, TValue> dictionary, TKey key, Func<TValue> factory, [MaybeNullWhen(false)] out TValue result) where TKey : notnull
        {
            ...
            try
            {
                result = dictionary.GetOrAdd(key, static (_, factory) => factory(), factory);
                return true;
            }
            catch (Exception)
            {
        ...
        public static TValue ConcurrentGetOrAdd<TKey, TValue>(this ConcurrentDictionary<TKey, TValue> dictionary, TKey key, Func<TValue> factory) where TKey : notnull
        {
            ...
            return dictionary.GetOrAdd(key, static (_, lazy) => lazy.Value, lazy);
        }
