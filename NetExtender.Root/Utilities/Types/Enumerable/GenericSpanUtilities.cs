...
namespace NetExtender.Utilities.Types
{
    ...
    public static partial class SpanUtilities
    {
		...
		public static Int32 Sum(this ReadOnlySpan<Int32> source)
		{
			checked
			{
				return source.Aggregate<Int32, Int32>(0, static (current, value) => current + value);
			}
		}
		...
		public static Int64 Sum(this ReadOnlySpan<Int64> source)
		{
			checked
			{
				return source.Aggregate<Int64, Int64>(0, static (current, value) => current + value);
			}
		}
		...
		public static Single Sum(this ReadOnlySpan<Single> source)
		{
			checked
			{
				return source.Aggregate<Single, Single>(0, static (current, value) => current + value);
			}
		}
		...
		public static Double Sum(this ReadOnlySpan<Double> source)
		{
			checked
			{
				return source.Aggregate<Double, Double>(0, static (current, value) => current + value);
			}
		}
		...
		public static Decimal Sum(this ReadOnlySpan<Decimal> source)
		{
			checked
			{
				return source.Aggregate<Decimal, Decimal>(0, static (current, value) => current + value);
			}
		}
