...
namespace NetExtender.Utilities.Types
{
    public static class EnumeratorUtilities
    {
        ...
        public static Boolean TryReset<TEnumerator>(this TEnumerator enumerator) where TEnumerator : class, IEnumerator
        {
        ...
        public static Boolean TryDispose<TEnumerator>(this TEnumerator enumerator) where TEnumerator : class, IEnumerator, IDisposable
        {
            if (enumerator is null)
            {
                throw new ArgumentNullException(nameof(enumerator));
        ...
        public static Boolean TryDispose<TEnumerator>(this ref TEnumerator enumerator) where TEnumerator : struct, IEnumerator, IDisposable
        {
            try
            {
                enumerator.Dispose();
