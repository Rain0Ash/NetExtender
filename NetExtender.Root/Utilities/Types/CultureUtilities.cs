...
namespace NetExtender.Utilities.Types
{
    ...
    public static class CultureUtilities
    {
        ...
        private static class CultureInfoCache
        {
            ...
            {
                return Storage.GetOrAdd(identifier, static localization => CultureInfo.GetCultureInfo(localization));
            }
        }
        ...
        {
            return identifier.Region is { } region ? GetUnicodeFlag(region) : null;
        }
        ...
        public static String? GetUnicodeFlag(this CultureInfo culture)
        {
            ...
            return culture.ToRegionInfo() is { } region ? GetUnicodeFlag(region) : null;
        }
        ...
        private static class RegionInfoStorage
        {
            ...
            {
                return Storage.GetOrAdd(identifier, static localization => new RegionInfo(localization));
            }
        }
