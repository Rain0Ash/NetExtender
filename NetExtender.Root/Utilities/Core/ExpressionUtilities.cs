...
namespace NetExtender.Utilities.Core
{
    public static class ExpressionUtilities
    {
        ...
        public static Expression<Func<T, TSource>> CreateNewExpression<TSource, T>()
        {
            ...
            {
                throw new MissingMemberException(typeof(TSource).Name, TypeUtilities.Constructor);
            }
        ...
        {
            return visitors is not null ? visitors.Aggregate(node, static (current, visitor) => visitor.Visit(current)) : node;
        }
    }
}