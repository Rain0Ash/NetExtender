...
namespace NetExtender.Utilities.IO
{
    public static class DirectoryUtilities
    {
        ...
        private static Func<String?> handler = static () => GetEntryDirectory(Assembly.GetEntryAssembly());
        ...
        internal static void SetCurrentDirectoryHandler(Func<String?> directory)
        {
            handler = directory ?? throw new ArgumentNullException(nameof(directory));
        }
        ...
        public static String? GetEntryDirectory(Assembly? assembly)
        {
            if (assembly is null)
            {
        ...
        public static Boolean DeleteAllFilesWithSuffix(this DirectoryInfo directory, String suffix, SearchOption option)
        {
            ...
            Int32 successful = files.Count(static file => file.TryDelete());
            return successful > 0;
        }
