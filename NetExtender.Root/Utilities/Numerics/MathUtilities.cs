...
namespace NetExtender.Utilities.Numerics
{
    ...
    public static partial class MathUtilities
    {
        ...
        {
            return value > 0 ? sizeof(UInt32) * BitUtilities.BitsInByte - BitOperations.LeadingZeroCount(value) : 0;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private static Int32 BinaryDigitsCount(UInt64 value)
        {
            return value > 0 ? sizeof(UInt64) * BitUtilities.BitsInByte - BitOperations.LeadingZeroCount(value) : 0;
        }
        ...
        public static Tuple<Double, Double, Double> FindQuartiles(IEnumerable<Double> values)
        {
            ...
            Double[] array = values.OrderBy(static value => value).ToArray();
