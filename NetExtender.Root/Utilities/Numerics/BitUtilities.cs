...
namespace NetExtender.Utilities.Numerics
{
    ...
    {
        public const Int32 BitsInByte = 8;
        private static ImmutableArray<ImmutableArray<Byte>> SetBitTable { get; }

        static BitUtilities()
        {
            ImmutableArray<ImmutableArray<Byte>>.Builder builder = ImmutableArray.CreateBuilder<ImmutableArray<Byte>>(Byte.MaxValue + 1);

            for (Int32 i = 0; i <= Byte.MaxValue; i++)
            {
                ImmutableArray<Byte>.Builder bits = ImmutableArray.CreateBuilder<Byte>();

                for (Byte bit = 0; bit < BitsInByte; bit++)
                {
                    if ((i & (1 << bit)) != 0)
                    {
                        bits.Add(bit);
                ...
                builder.Add(bits.ToImmutable());
            }

            SetBitTable = builder.ToImmutable();
        }
        ...
        public static void Deconstruct(this Char value, out Byte high, out Byte low)
        {
            unchecked
            {
                high = (Byte) (value >> (sizeof(Byte) * BitsInByte));
        ...
        public static void Deconstruct(this Int32 value, out UInt16 high, out UInt16 low)
        {
            unchecked
            {
                high = (UInt16) (value >> (sizeof(UInt16) * BitsInByte));
        ...
        public static void Deconstruct(this Int64 value, out UInt32 high, out UInt32 low)
        {
            unchecked
            {
                high = (UInt32) (value >> (sizeof(UInt32) * BitsInByte));
        ...
        public static Int16 ToInt16(SByte high, Byte low)
        {
            unchecked
            {
                return (Int16) (high << (sizeof(SByte) * BitsInByte) | low);
            }
        }
        ...
        {
            return (UInt16) ((high << (sizeof(Byte) * BitsInByte)) | low);
        }
        ...
        {
            return high << (sizeof(Int16) * BitsInByte) | low;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public static UInt32 ToUInt32(UInt16 high, UInt16 low)
        {
            return ((UInt32) high << (sizeof(UInt16) * BitsInByte)) | low;
        }
        ...
        {
            return (Int64) high << (sizeof(Int32) * BitsInByte) | low;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public static UInt64 ToUInt64(UInt32 high, UInt32 low)
        {
            return ((UInt64) high << (sizeof(UInt32) * BitsInByte)) | low;
        }
        ...
        public static unsafe Boolean TryGetSetBits(void* pointer, UInt32 length, Span<Int32> destination, out Int32 written)
        {
            ...
            Span<Int32> position = stackalloc Int32[BitsInByte];
            for (Int32 i = 0; i < length; i++)
            {
                ...
                {
                    destination[written++] = position[j] + BitsInByte * i;
                }
            }
        ...
        public static unsafe Boolean TryGetSetBits(void* pointer, UInt32 length, Span<UInt32> destination, out Int32 written)
        {
            ...
            Span<UInt32> position = stackalloc UInt32[BitsInByte];
        ...
        public static unsafe void BitwiseShiftLeft(void* source, UInt32 length, Int32 shift)
        {
            ...
            if ((UInt64) shift >= (UInt64) length * BitsInByte)
            {
            ...
            {
                Byte* pointer = (Byte*) source;
                Int32 offset = Math.DivRem(shift, BitsInByte, out shift);
                ...
                Int32 suboffset = BitsInByte - shift;
