...
namespace NetExtender.Utilities.Numerics
{
    ...
    public static partial class BitUtilities
    {
		...
		public static SByte BitwiseShiftLeftTrue(this SByte value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					...
					>= sizeof(Byte) * BitsInByte => (SByte) Byte.MaxValue,
					_ => (SByte) (value << shift | (Byte.MaxValue >> (sizeof(Byte) * BitsInByte - shift)))
				};
			}
		}
		...
		public static Byte BitwiseShiftLeftTrue(this Byte value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					0 => value,
					< 0 => BitwiseShiftRightTrue(value, -shift),
					>= sizeof(Byte) * BitsInByte => Byte.MaxValue,
					_ => (Byte) (value << shift | (Byte.MaxValue >> (sizeof(Byte) * BitsInByte - shift)))
				};
			}
		}
		...
		public static Int16 BitwiseShiftLeftTrue(this Int16 value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					0 => value,
					< 0 => BitwiseShiftRightTrue(value, -shift),
					>= sizeof(UInt16) * BitsInByte => (Int16) UInt16.MaxValue,
					_ => (Int16) (value << shift | (UInt16.MaxValue >> (sizeof(UInt16) * BitsInByte - shift)))
				};
			}
		}
		...
		public static UInt16 BitwiseShiftLeftTrue(this UInt16 value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					0 => value,
					< 0 => BitwiseShiftRightTrue(value, -shift),
					>= sizeof(UInt16) * BitsInByte => UInt16.MaxValue,
					_ => (UInt16) (value << shift | (UInt16.MaxValue >> (sizeof(UInt16) * BitsInByte - shift)))
				};
			}
		}
		...
		public static Int32 BitwiseShiftLeftTrue(this Int32 value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					0 => value,
					< 0 => BitwiseShiftRightTrue(value, -shift),
					>= sizeof(UInt32) * BitsInByte => (Int32) UInt32.MaxValue,
					_ => (Int32) ((UInt32) value << shift | (UInt32.MaxValue >> (sizeof(UInt32) * BitsInByte - shift)))
				};
			}
		}
		...
		public static UInt32 BitwiseShiftLeftTrue(this UInt32 value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					0 => value,
					< 0 => BitwiseShiftRightTrue(value, -shift),
					>= sizeof(UInt32) * BitsInByte => UInt32.MaxValue,
					_ => value << shift | (UInt32.MaxValue >> (sizeof(UInt32) * BitsInByte - shift))
				};
			}
		}
		...
		public static Int64 BitwiseShiftLeftTrue(this Int64 value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					0 => value,
					< 0 => BitwiseShiftRightTrue(value, -shift),
					>= sizeof(UInt64) * BitsInByte => (Int64) UInt64.MaxValue,
					_ => (Int64) ((UInt64) value << shift | (UInt64.MaxValue >> (sizeof(UInt64) * BitsInByte - shift)))
				};
			}
		}
		...
		public static UInt64 BitwiseShiftLeftTrue(this UInt64 value, Int32 shift)
		{
			unchecked
			{
				return shift switch
				{
					0 => value,
					< 0 => BitwiseShiftRightTrue(value, -shift),
					>= sizeof(UInt64) * BitsInByte => UInt64.MaxValue,
					_ => value << shift | (UInt64.MaxValue >> (sizeof(UInt64) * BitsInByte - shift))
				};
			}
		}
		...
		{
			const Int32 size = sizeof(SByte) * BitsInByte;
		...
		{
			const Int32 size = sizeof(Byte) * BitsInByte;
		...
		{
			const Int32 size = sizeof(Int16) * BitsInByte;
		...
		{
			const Int32 size = sizeof(UInt16) * BitsInByte;
		...
		{
			const Int32 size = sizeof(Int32) * BitsInByte;
		...
		{
			const Int32 size = sizeof(UInt32) * BitsInByte;
		...
		{
			const Int32 size = sizeof(Int64) * BitsInByte;
		...
		{
			const Int32 size = sizeof(UInt64) * BitsInByte;
		...
		public static SByte BitwiseFillLeft(this SByte value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				if (count >= sizeof(Byte) * BitsInByte)
				{
					return bit ? (SByte) Byte.MaxValue : default;
				}

				return bit
					? (SByte) ((Byte) value | (Byte.MaxValue << (sizeof(Byte) * BitsInByte - count)))
					: (SByte) ((Byte) value & (Byte.MaxValue >> (sizeof(Byte) * BitsInByte - count)));
			}
		}
		...
		public static Byte BitwiseFillLeft(this Byte value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				...
				return bit
					? (Byte) (value | (Byte.MaxValue << (sizeof(Byte) * BitsInByte - count)))
					: (Byte) (value & (Byte.MaxValue >> (sizeof(Byte) * BitsInByte - count)));
			}
		}
		...
		public static Int16 BitwiseFillLeft(this Int16 value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				if (count >= sizeof(UInt16) * BitsInByte)
				{
					return bit ? (Int16) UInt16.MaxValue : default;
				}

				return bit
					? (Int16) ((UInt16) value | (UInt16.MaxValue << (sizeof(UInt16) * BitsInByte - count)))
					: (Int16) ((UInt16) value & (UInt16.MaxValue >> (sizeof(UInt16) * BitsInByte - count)));
			}
		}
		...
		public static UInt16 BitwiseFillLeft(this UInt16 value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				...
				return bit
					? (UInt16) (value | (UInt16.MaxValue << (sizeof(UInt16) * BitsInByte - count)))
					: (UInt16) (value & (UInt16.MaxValue >> (sizeof(UInt16) * BitsInByte - count)));
			}
		}
		...
		public static Int32 BitwiseFillLeft(this Int32 value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				if (count >= sizeof(UInt32) * BitsInByte)
				{
					return bit ? (Int32) UInt32.MaxValue : default;
				}

				return bit
					? (Int32) ((UInt32) value | (UInt32.MaxValue << (sizeof(UInt32) * BitsInByte - count)))
					: (Int32) ((UInt32) value & (UInt32.MaxValue >> (sizeof(UInt32) * BitsInByte - count)));
			}
		}
		...
		public static UInt32 BitwiseFillLeft(this UInt32 value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				...
				return bit
					? value | (UInt32.MaxValue << (sizeof(UInt32) * BitsInByte - count))
					: value & (UInt32.MaxValue >> (sizeof(UInt32) * BitsInByte - count));
			}
		}
		...
		public static Int64 BitwiseFillLeft(this Int64 value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				if (count >= sizeof(UInt64) * BitsInByte)
				{
					return bit ? (Int64) UInt64.MaxValue : default;
				}

				return bit
					? (Int64) ((UInt64) value | (UInt64.MaxValue << (sizeof(UInt64) * BitsInByte - count)))
					: (Int64) ((UInt64) value & (UInt64.MaxValue >> (sizeof(UInt64) * BitsInByte - count)));
			}
		}
		...
		public static UInt64 BitwiseFillLeft(this UInt64 value, Int32 count, Boolean bit)
		{
			...
			unchecked
			{
				...
				return bit
					? value | (UInt64.MaxValue << (sizeof(UInt64) * BitsInByte - count))
					: value & (UInt64.MaxValue >> (sizeof(UInt64) * BitsInByte - count));
			}
		}
		...
		public static SByte High(this Int16 value)
		{
			unchecked
			{
				return (SByte) (value >> sizeof(SByte) * BitsInByte);
			}
		}
		...
		public static Byte High(this UInt16 value)
		{
			unchecked
			{
				return (Byte) (value >> sizeof(Byte) * BitsInByte);
			}
		}
		...
		public static Int16 High(this Int32 value)
		{
			unchecked
			{
				return (Int16) (value >> sizeof(Int16) * BitsInByte);
			}
		}
		...
		public static UInt16 High(this UInt32 value)
		{
			unchecked
			{
				return (UInt16) (value >> sizeof(UInt16) * BitsInByte);
			}
		}
		...
		public static Int32 High(this Int64 value)
		{
			unchecked
			{
				return (Int32) (value >> sizeof(Int32) * BitsInByte);
			}
		}
		...
		public static UInt32 High(this UInt64 value)
		{
			unchecked
			{
				return (UInt32) (value >> sizeof(UInt32) * BitsInByte);
			}
		}
