...
namespace NetExtender.Utilities.Numerics
{
    ...
    public static partial class RandomUtilities
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Span<Byte> Fill<TRandom>(this TRandom random, Span<Byte> value) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Byte[] Fill<TRandom>(this TRandom random, Byte[] value) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 Next<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextInt32(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 Next<TRandom>(this TRandom random, Int32 max) where TRandom : IRandom
        {
            return NextInt32(random, max);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 Next<TRandom>(this TRandom random, Int32 min, Int32 max) where TRandom : IRandom
        {
            return NextInt32(random, min, max);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 NextNonNegative<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextNonNegativeInt32(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 NextNonNegative<TRandom>(this TRandom random, Int32 max) where TRandom : IRandom
        {
            return NextNonNegativeInt32(random, max);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 NextNonNegative<TRandom>(this TRandom random, Int32 min, Int32 max) where TRandom : IRandom
        {
            return NextNonNegativeInt32(random, min, max);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 NextNonZero<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextNonZeroInt32(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 NextNonZero<TRandom>(this TRandom random, Int32 max) where TRandom : IRandom
        {
            return NextNonZeroInt32(random, max);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int32 NextNonZero<TRandom>(this TRandom random, Int32 min, Int32 max) where TRandom : IRandom
        {
            return NextNonZeroInt32(random, min, max);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single NextSingle<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextSingleWithOne(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single NextSingle<TRandom>(this TRandom random, Boolean include) where TRandom : IRandom
        {
            return include ? NextSingleWithOne(random) : NextSingleWithoutOne(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single NextSingleWithOne<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return (Single) NextDoubleWithOne(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single NextSingleWithoutOne<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return (Single) NextDoubleWithoutOne(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Single NextSingle<TRandom>(this TRandom random, Single max) where TRandom : IRandom
        {
            return NextSingle(random) * max;
        }
        ...
        public static Single NextSingle<TRandom>(this TRandom random, Single min, Single max) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double NextDouble<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextDoubleWithOne(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double NextDouble<TRandom>(this TRandom random, Boolean include) where TRandom : IRandom
        {
            return include ? NextDoubleWithOne(random) : NextDoubleWithoutOne(random);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double NextDoubleWithOne<TRandom>(this TRandom random) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double NextDoubleWithoutOne<TRandom>(this TRandom random) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double NextDouble<TRandom>(this TRandom random, Double max) where TRandom : IRandom
        {
            return NextDouble(random) * max;
        }
        ...
        public static Double NextDouble<TRandom>(this TRandom random, Double min, Double max) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Decimal NextDecimal<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextDecimal(random, Decimal.MaxValue);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Decimal NextDecimal<TRandom>(this TRandom random, Decimal max) where TRandom : IRandom
        {
            return new Decimal(NextDouble(random)) * max;
        }
        ...
        public static Decimal NextDecimal<TRandom>(this TRandom random, Decimal min, Decimal max) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolean NextBoolean<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextBoolean(random, 0.5D);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolean NextBoolean<TRandom>(this TRandom random, Double chance) where TRandom : IRandom
        {
            return chance switch
            {
                >= 1 => true,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Complex NextComplex<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return new Complex(NextDouble(random), NextDouble(random));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Complex NextComplex<TRandom>(this TRandom random, Double max) where TRandom : IRandom
        {
            return new Complex(NextDouble(random, max), NextDouble(random, max));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Complex NextComplex<TRandom>(this TRandom random, Double min, Double max) where TRandom : IRandom
        {
            return NextComplex(random, min, max, min, max);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Complex NextComplex<TRandom>(this TRandom random, Double min, Double max, Double imin, Double imax) where TRandom : IRandom
        {
            return new Complex(NextDouble(random, min, max), NextDouble(random, imin, imax));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimeSpan NextTimeSpan<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextTimeSpan(random, TimeSpan.MaxValue);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimeSpan NextTimeSpan<TRandom>(this TRandom random, TimeSpan max) where TRandom : IRandom
        {
            return NextTimeSpan(random, TimeSpan.Zero, max);
        }
        ...
        public static TimeSpan NextTimeSpan<TRandom>(this TRandom random, TimeSpan min, TimeSpan max) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DateTime NextDateTime<TRandom>(this TRandom random) where TRandom : IRandom
        {
            return NextDateTime(random, DateTime.MaxValue);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DateTime NextDateTime<TRandom>(this TRandom random, DateTime max) where TRandom : IRandom
        {
            return NextDateTime(random, DateTime.MinValue, max);
        }
        ...
        public static DateTime NextDateTime<TRandom>(this TRandom random, DateTime min, DateTime max) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<Boolean> RangeChance<TRandom>(this TRandom random) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<Boolean> RangeChance<TRandom>(this TRandom random, Int32 count) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<Boolean> RangeChance<TRandom>(this TRandom random, Double chance) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<Boolean> RangeChance<TRandom>(this TRandom random, Double chance, Int32 count) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        public static Double[] Summary(this Random random, UInt32 min, UInt32 max, Int32 count)
        {
            ...
            Array.Sort(values, static (first, second) => second.CompareTo(first));
            return values;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double[] Summary<TRandom>(this TRandom random, Int32 count) where TRandom : IRandom
        {
            return Summary(random, UInt32.MaxValue, count);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double[] Summary<TRandom>(this TRandom random, Int32 max, Int32 count) where TRandom : IRandom
        {
            return Summary(random, default, max, count);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double[] Summary<TRandom>(this TRandom random, Int32 min, Int32 max, Int32 count) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Double[] Summary<TRandom>(this TRandom random, UInt32 max, Int32 count) where TRandom : IRandom
        {
            return Summary(random, default, max, count);
        }

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static Double[] Summary<TRandom>(this TRandom random, UInt32 min, UInt32 max, Int32 count) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Decimal[] Summary<TRandom>(this TRandom random, Decimal max, Int32 count) where TRandom : IRandom
        {
            return Summary(random, default, max, count);
        }

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static Decimal[] Summary<TRandom>(this TRandom random, Decimal min, Decimal max, Int32 count) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
        ...
        public static void Reset<TRandom>(TRandom random) where TRandom : IRandom
        {
            if (random is null)
            {
                throw new ArgumentNullException(nameof(random));
