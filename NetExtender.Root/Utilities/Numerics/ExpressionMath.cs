...
namespace NetExtender.Utilities.Numerics
{
    ...
    public static class MathGeneric<T, TResult>
    {
        static MathGeneric()
        {
            ConvertLazy = new Lazy<Func<T, TResult>>(static () => ExpressionUtilities.CreateExpression<T, TResult>(static body => Expression.Convert(body, typeof(TResult))), true);
            AddLazy = new Lazy<Func<TResult, T, TResult>>(static () => ExpressionUtilities.CreateExpression<TResult, T, TResult>(Expression.Add, true), true);
            SubtractLazy = new Lazy<Func<TResult, T, TResult>>(static () => ExpressionUtilities.CreateExpression<TResult, T, TResult>(Expression.Subtract, true), true);
            MultiplyLazy = new Lazy<Func<TResult, T, TResult>>(static () => ExpressionUtilities.CreateExpression<TResult, T, TResult>(Expression.Multiply, true), true);
            DivideLazy = new Lazy<Func<TResult, T, TResult>>(static () => ExpressionUtilities.CreateExpression<TResult, T, TResult>(Expression.Divide, true), true);
            ModuloLazy = new Lazy<Func<TResult, T, TResult>>(static () => ExpressionUtilities.CreateExpression<TResult, T, TResult>(Expression.Modulo, true), true);
        }
    ...
    public static class MathGeneric<T>
    {
        static MathGeneric()
        {
            ...
            AddLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.Add), true);
            SubtractLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.Subtract), true);
            MultiplyLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.Multiply), true);
            DivideLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.Divide), true);
            ModuloLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.Modulo), true);

            EqualsLazy = new Lazy<Func<T, T, Boolean>>(static () => ExpressionUtilities.CreateExpression<T, T, Boolean>(Expression.Equal), true);
            NotEqualsLazy = new Lazy<Func<T, T, Boolean>>(static () => ExpressionUtilities.CreateExpression<T, T, Boolean>(Expression.NotEqual), true);
            GreaterLazy = new Lazy<Func<T, T, Boolean>>(static () => ExpressionUtilities.CreateExpression<T, T, Boolean>(Expression.GreaterThan), true);
            GreaterOrEqualsLazy = new Lazy<Func<T, T, Boolean>>(static () => ExpressionUtilities.CreateExpression<T, T, Boolean>(Expression.GreaterThanOrEqual), true);
            LessLazy = new Lazy<Func<T, T, Boolean>>(static () => ExpressionUtilities.CreateExpression<T, T, Boolean>(Expression.LessThan), true);
            LessOrEqualsLazy = new Lazy<Func<T, T, Boolean>>(static () => ExpressionUtilities.CreateExpression<T, T, Boolean>(Expression.LessThanOrEqual), true);

            NegateLazy = new Lazy<Func<T, T>>(static () => ExpressionUtilities.CreateExpression<T, T>(Expression.Negate), true);
            AndLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.And), true);
            OrLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.Or), true);
            NotLazy = new Lazy<Func<T, T>>(static () => ExpressionUtilities.CreateExpression<T, T>(Expression.Not), true);
            XorLazy = new Lazy<Func<T, T, T>>(static () => ExpressionUtilities.CreateExpression<T, T, T>(Expression.ExclusiveOr), true);
        }
