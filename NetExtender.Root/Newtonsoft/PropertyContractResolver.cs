...
namespace NetExtender.Newtonsoft
{
    ...
    {
        private Dictionary<Type, ISet<String>> Ignore { get; }
        private Dictionary<Type, IDictionary<String, String>> Rename { get; }
        private Dictionary<Type, IDictionary<String, Int32>> Order { get; }
        ...
        public PropertyContractResolver IgnoreProperty(Type type, params String?[] properties)
        {
            ...
            foreach (String property in properties.WhereNotNullOrEmpty())
            {
                Ignore[type].Add(property);
            }
        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization serialization)
        {
            ...
            {
                handler.ShouldSerialize = static _ => false;
