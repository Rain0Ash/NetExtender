...
namespace NetExtender.Exceptions
{
    ...
    public class TypeNotSupportedException : NotSupportedException
    {
        ...
        public TypeNotSupportedException(MonoCecilType type)
        {
            Type = type;
        }
        ...
        public TypeNotSupportedException(MonoCecilType type, String? message)
            : base(message)
        {
            Type = type;
        }
        ...
        public TypeNotSupportedException(MonoCecilType type, String? message, Exception? exception)
            : base(message, exception)
        {
            Type = type;
        }
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue(nameof(Type), Type.Type);
        }
    }
}