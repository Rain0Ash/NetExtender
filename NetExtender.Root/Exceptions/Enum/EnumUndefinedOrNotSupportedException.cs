...
namespace NetExtender.Exceptions
{
    ...
    public class EnumUndefinedOrNotSupportedException<T> : ExceptionWrapper<Exception> where T : unmanaged, Enum
    {
        ...
        public EnumUndefinedOrNotSupportedException(T value, String? parameter, String? message, Exception? exception)
            : base(value.In() ? EnumNotSupportedException<T>.Create(value, message, exception) : exception is not null ? EnumUndefinedException<T>.Create(value, message, exception) : EnumUndefinedException<T>.Create(value, parameter, message))
        {
        }
