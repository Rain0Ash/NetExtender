...
{
    [Serializable]
    public struct MathResult<T> : IMathResult<T>, IResultEquality<Result<T, OverflowException>>, IResultEquality<BusinessResult<T>>, IResultEquality<MathResult<T>> where T : struct, IEquatable<T>, IFormattable
    {
        static MathResult()
        {
            MathResult.Initialize();
        }
        ...
        {
            return value is not null ? new MathResult<T>(value.Throwable()) : default;
        }

        [StackTraceHidden]
        public static implicit operator MathResult<T>(ExceptionWrapper<ArgumentException>? value)
        {
            return value is not null ? new MathResult<T>(value.Exception.Throwable()) : default;
        }
        ...
        public Boolean ReferenceEquals(Result<T, OverflowException> other)
        {
            return _internal.ReferenceEquals(other);
        }
        ...
        public Boolean ReferenceEquals(MathResult<T> other)
        {
            return _internal.ReferenceEquals(other._internal);
        }
        ...
        public Boolean ReferenceEquals(IMathResult<T>? other)
        {
            return _internal.ReferenceEquals(other);
        }
