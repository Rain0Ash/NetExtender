...
namespace NetExtender.Types.Immutable.Dictionaries
{
    ...
    public sealed class ImmutableNullableDictionary<TKey, TValue> : IImmutableDictionary<TKey, TValue>, IDictionary<TKey, TValue>, IDictionary
    {
        ...
        {
            ImmutableDictionary<NullMaybe<TKey>, TValue> @new = pairs is not null ? Internal.AddRange(EnumerableBaseUtilities.KeyNullable(pairs)) : Internal;
            return @new != Internal ? Self(@new) : this;
        }
        ...
        {
            ImmutableDictionary<NullMaybe<TKey>, TValue> @new = items is not null ? Internal.SetItems(EnumerableBaseUtilities.KeyNullable(items)) : Internal;
            return @new != Internal ? Self(@new) : this;
        }
        ...
        {
            ImmutableDictionary<NullMaybe<TKey>, TValue> @new = keys is not null ? Internal.RemoveRange(EnumerableBaseUtilities.Nullable(keys)) : Internal;
            return @new != Internal ? Self(@new) : this;
        }
