...
namespace NetExtender.Types.Concurrent.Observable.Interfaces
{
    ...
    public interface IReadOnlyConcurrentObservableSortedDictionary<TKey, TValue> : IReadOnlyConcurrentObservableDictionary<TKey, TValue>, IReadOnlySortedDictionary<TKey, TValue>
    {
        public new ImmutableNullableSortedDictionary<TKey, TValue> Immutable { get; }
    }
}