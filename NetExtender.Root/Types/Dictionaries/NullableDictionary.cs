...
namespace NetExtender.Types.Dictionaries
{
    ...
    public class NullableDictionary<TKey, TValue> : Dictionary<NullMaybe<TKey>, TValue>, IHashDictionary<TKey, TValue>, IReadOnlyHashDictionary<TKey, TValue>
    {
        ...
        public NullableDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
            : base(collection is not null ? EnumerableBaseUtilities.KeyNullable(collection) : throw new ArgumentNullException(nameof(collection)))
        {
        }
        ...
        public NullableDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer)
            : this(collection is not null ? EnumerableBaseUtilities.KeyNullable(collection) : throw new ArgumentNullException(nameof(collection)), comparer)
        {
        }

        public NullableDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<NullMaybe<TKey>>? comparer)
            : base(collection is not null ? EnumerableBaseUtilities.KeyNullable(collection) : throw new ArgumentNullException(nameof(collection)), comparer)
        {
        }
        ...
        {
            EnumerableBaseUtilities.CopyTo(this, array, index);
        }
