...
namespace NetExtender.FileSystems
{
    public partial class FileSystemHandlerWrapper<T>
    {
        ...
        public override ReadOnlySpan<Char> DirectorySeparatorCharacters
        {
            get
            {
                return FileSystem.Path.DirectorySeparatorCharacters;
            }
        }
        ...
        public override ReadOnlySpan<Char> InvalidPathCharacters
        {
            get
            {
        ...
        public override ReadOnlySpan<Char> InvalidFileNameCharacters
        {
            get
            {
