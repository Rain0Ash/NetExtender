...
namespace NetExtender.FileSystems
{
    public readonly struct FileSystemUri : IEquatableStruct<FileSystemUri>, IReadOnlyList<Char>, IEnumerable<FileSystemUri.Segment>, IEquatable<FileSystemUri.Enumerator>
    {
        ...
        /// <inheritdoc cref="IPathHandler.DirectorySeparatorCharacters" />
        public ReadOnlySpan<Char> DirectorySeparatorCharacters
        {
            get
            {
                return FileSystem is not null ? FileSystem.Path.DirectorySeparatorCharacters : new[] { Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar };
            }
        }

        /// <inheritdoc cref="IPathHandler.InvalidPathCharacters" />
        public ReadOnlySpan<Char> InvalidPathCharacters
        {
            get
            {
                return FileSystem is not null ? FileSystem.Path.InvalidPathCharacters : Path.GetInvalidPathChars();
            }
        }

        /// <inheritdoc cref="IPathHandler.InvalidFileNameCharacters" />
        public ReadOnlySpan<Char> InvalidFileNameCharacters
        {
            get
            {
                return FileSystem is not null ? FileSystem.Path.InvalidFileNameCharacters : Path.GetInvalidFileNameChars();
            }
        }
        ...
        private readonly Boolean? _sensitive = null;
        public Boolean? IsCaseSensitive
        {
            get
            {
                return _sensitive ?? FileSystem?.IsCaseSensitive;
            }
            init
            {
                _sensitive = value;
        ...
        {
            return Equals(FileSystem, other.FileSystem) && String.Equals(Uri, other.Uri, IsCaseSensitive is not false ? StringComparison.Ordinal : StringComparison.OrdinalIgnoreCase);
        }
        ...
        public readonly struct Segment : IEquatableStruct<Segment>
        {
            ...
            {
                return Type == other.Type && _value.SequenceEqual(other._value, IsCaseSensitive is not false ? CharEqualityComparer.Ordinal : CharEqualityComparer.OrdinalIgnoreCase);
            }
        ...
        public struct Enumerator : IEquatableStruct<Enumerator>, IEnumerator<Segment>, IEquatable<FileSystemUri>
        {
            ...
            /// <inheritdoc cref="IPathHandler.DirectorySeparatorCharacters" />
            public readonly ReadOnlySpan<Char> DirectorySeparatorCharacters
            {
                get
                {
                    return _uri.DirectorySeparatorCharacters;
                }
            }

            /// <inheritdoc cref="IPathHandler.InvalidPathCharacters" />
            public readonly ReadOnlySpan<Char> InvalidPathCharacters
            {
                get
                {
            ...
            /// <inheritdoc cref="IPathHandler.InvalidFileNameCharacters" />
            public readonly ReadOnlySpan<Char> InvalidFileNameCharacters
            {
                get
                {
            ...
            private readonly SegmentType ProcessAlternateStream(ReadOnlySpan<Char> uri)
            {
                ...
                return stream.IndexOfAny(InvalidFileNameCharacters) < 0 ? SegmentType.AlternateDataStream : SegmentType.File;
            }
