...
{
    public interface IUnsafeEnvironmentHandler : IEnvironmentHandler
    {
        /// <inheritdoc cref="IEnvironmentHandler.GetFolderPath(System.Environment.SpecialFolder)" />
        public new DirectoryInfo? GetFolderPath(Environment.SpecialFolder folder);

        /// <inheritdoc cref="IEnvironmentHandler.GetFolderPath(System.Environment.SpecialFolder, System.Environment.SpecialFolderOption)" />
        public new DirectoryInfo? GetFolderPath(Environment.SpecialFolder folder, Environment.SpecialFolderOption option);
    }
