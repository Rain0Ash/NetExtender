...
{
    public interface IUnsafeLinkHandler : ILinkHandler
    {
        /// <inheritdoc cref="ILinkHandler.CreateSymbolicLink(System.String, System.String)" />
        public new FileSystemInfo CreateSymbolicLink(String path, String target);

        /// <inheritdoc cref="ILinkHandler.ResolveLinkTarget(System.String, System.Boolean)" />
