...
{
    public interface IUnsafeFileHandler : IFileHandler
    {
        /// <inheritdoc cref="IFileHandler.CreateSymbolicLink(System.String, System.String)" />
        public new FileSystemInfo CreateSymbolicLink(String path, String target);

        /// <inheritdoc cref="IFileHandler.ResolveLinkTarget(System.String, System.Boolean)" />
