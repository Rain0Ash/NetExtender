...
{
    public interface IUnsafeDirectoryHandler : IDirectoryHandler
    {
        /// <inheritdoc cref="IDirectoryHandler.CreateDirectory(System.String)" />
        public new DirectoryInfo CreateDirectory(String path);

#if NET7_0_OR_GREATER
        /// <inheritdoc cref="IDirectoryHandler.CreateDirectory(System.String, System.IO.UnixFileMode)" />
#endif
        public new DirectoryInfo CreateDirectory(String path, UnixFileMode mode);

        /// <inheritdoc cref="IDirectoryHandler.CreateSymbolicLink(System.String, System.String)" />
        public new FileSystemInfo CreateSymbolicLink(String path, String target);

        /// <inheritdoc cref="IDirectoryHandler.ResolveLinkTarget(System.String, System.Boolean)" />
        public new FileSystemInfo? ResolveLinkTarget(String path, Boolean target);

        /// <inheritdoc cref="IDirectoryHandler.GetParent(System.String)" />
