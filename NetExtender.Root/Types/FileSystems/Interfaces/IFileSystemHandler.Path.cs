...
{
    public interface IUnsafePathHandler : IPathHandler
    {
    }
    ...
    public interface IPathHandler : INotifyProperty, IDisposable
    {
        ...
        public ReadOnlySpan<Char> DirectorySeparatorCharacters { get; }
        ...
        public ReadOnlySpan<Char> InvalidPathCharacters { get; }
        ...
        public ReadOnlySpan<Char> InvalidFileNameCharacters { get; }
