...
#pragma warning disable CS0618
        internal interface IHandler : IFileSystemHandler
        {
        }
#pragma warning restore CS0618
        ...
        protected DateTimeOffset CreationTimeOffset { get; private protected init; } = DateTimeOffset.Now;
        ...
        public virtual IPathHandler Path
        {
            get
            {
                return this;
        ...
        public virtual ILinkHandler Link
        {
            get
            {
                return this;
        ...
        public virtual IFileHandler File
        {
            get
            {
                return this;
        ...
        public virtual IDirectoryHandler Directory
        {
            get
            {
                return this;
        ...
        public virtual IDriveHandler Drive
        {
            get
            {
                return this;
        ...
        public virtual IEnvironmentHandler Environment
        {
            get
            {
                return this;
        ...
        public virtual Encoding? Encoding { get; init; }

        private protected readonly Encoding? _read;
        public virtual Encoding ReadEncoding
        {
            get
            {
        ...
        private protected readonly Encoding? _write;
        public virtual Encoding WriteEncoding
        {
            get
            {
        ...
        private protected virtual Boolean IsUnsafeFileSystem()
        {
            return false;
        }
        ...
        protected virtual IFileSystemInfo CreateSymbolicLink(String path, String target, FileSystemHandlerType handler)
        {
            return handler switch
            {
                ...
                FileSystemHandlerType.Link or FileSystemHandlerType.File => FileSystemInfoWrapper.Create(System.IO.File.CreateSymbolicLink(path, target)),
        ...
        protected virtual IFileSystemInfo? ResolveLinkTarget(String path, Boolean target, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => FileSystemInfoWrapper.Create(System.IO.File.ResolveLinkTarget(path, target)),
        ...
        protected virtual Boolean Exists([NotNullWhen(true)] String? path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.Exists(path),
        ...
        protected virtual FileAttributes GetAttributes(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.GetAttributes(path),
        ...
        protected virtual UnixFileMode GetUnixFileMode(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                ...
                FileSystemHandlerType.Link or FileSystemHandlerType.File => RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? ~UnixFileMode.None : System.IO.File.GetUnixFileMode(path),
#else
                FileSystemHandlerType.Link or FileSystemHandlerType.File => RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? ~UnixFileMode.None : throw new NotSupportedException(),
#endif
                FileSystemHandlerType.Directory => throw new NotSupportedException(),
                FileSystemHandlerType.Drive => throw new NotSupportedException(),
                _ => throw new EnumUndefinedOrNotSupportedException<FileSystemHandlerType>(handler, nameof(handler), null)
        ...
        protected virtual void SetUnixFileMode(String path, UnixFileMode mode, FileSystemHandlerType handler)
        {
            switch (handler)
            {
                ...
                case FileSystemHandlerType.Directory:
                    throw new NotSupportedException();
                case FileSystemHandlerType.Link or FileSystemHandlerType.File when RuntimeInformation.IsOSPlatform(OSPlatform.Windows):
                    return;
                case FileSystemHandlerType.Link or FileSystemHandlerType.File:
#if NET7_0_OR_GREATER
        ...
        protected virtual DateTime GetCreationTime(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.GetCreationTime(path),
        ...
        protected virtual DateTime GetCreationTimeUtc(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.GetCreationTimeUtc(path),
        ...
        protected virtual DateTime GetLastAccessTime(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.GetLastAccessTime(path),
        ...
        protected virtual DateTime GetLastAccessTimeUtc(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.GetLastAccessTimeUtc(path),
        ...
        protected virtual DateTime GetLastWriteTime(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.GetLastWriteTime(path),
        ...
        protected virtual DateTime GetLastWriteTimeUtc(String path, FileSystemHandlerType handler)
        {
            return handler switch
            {
                FileSystemHandlerType.Unknown => throw new AmbiguousFileSystemHandlerException(),
                FileSystemHandlerType.Path => throw new NotSupportedException(),
                FileSystemHandlerType.Link or FileSystemHandlerType.File => System.IO.File.GetLastWriteTimeUtc(path),
