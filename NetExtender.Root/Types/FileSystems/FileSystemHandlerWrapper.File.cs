...
namespace NetExtender.FileSystems
{
    public partial class FileSystemHandlerWrapper<T>
    {
        ...
        {
            return FileSystem.File.ReadAllText(path, encoding ?? _read);
        }
        ...
        {
            return FileSystem.File.ReadAllTextAsync(path, encoding ?? _read, token);
        }
        ...
        {
            return FileSystem.File.ReadAllLines(path, encoding ?? _read);
        }
        ...
        {
            return FileSystem.File.ReadAllLinesAsync(path, encoding ?? _read, token);
        }
        ...
        {
            FileSystem.File.AppendAllText(path, contents, encoding ?? _write);
        }
        ...
        {
            return FileSystem.File.AppendAllTextAsync(path, contents, encoding ?? _write, token);
        }
        ...
        {
            FileSystem.File.AppendAllLines(path, contents, encoding ?? _write);
        }
        ...
        {
            return FileSystem.File.AppendAllLinesAsync(path, contents, encoding ?? _write, token);
        }
        ...
        {
            FileSystem.File.WriteAllText(path, contents, encoding ?? _write);
        }
        ...
        {
            return FileSystem.File.WriteAllTextAsync(path, contents, encoding ?? _write, token);
        }
        ...
        {
            FileSystem.File.WriteAllLines(path, contents, encoding ?? _write);
        }
        ...
        {
            return FileSystem.File.WriteAllLinesAsync(path, contents, encoding ?? _write, token);
        }
    }
}