...
namespace NetExtender.FileSystems
{
    public partial class FileSystemHandler
    {
        ...
        public virtual ReadOnlySpan<Char> DirectorySeparatorCharacters
        {
            get
            {
                return _characters ??= new [] { DirectorySeparatorChar, AltDirectorySeparatorChar };
            }
        }
        ...
        private Char[]? _path;
        public virtual ReadOnlySpan<Char> InvalidPathCharacters
        {
            get
            {
        ...
        public virtual ReadOnlySpan<Char> InvalidFileNameCharacters
        {
            get
            {
                return _filename ??= GetInvalidFileNameChars();
            }
        }
