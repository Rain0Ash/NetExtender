...
namespace NetExtender.Types.Sets
{
    public class OrderedSet<T> : ISet, ISet<T>, IReadOnlySet<T>
    {
        ...
        public Boolean IsSubsetOf(IEnumerable<T> other)
        {
            ...
            return other switch
            {
                ISet<T> set => set.IsSupersetOf(Link),
                IImmutableSet<T> set => set.IsSupersetOf(Link),
                IReadOnlySet<T> set => set.IsSupersetOf(Link),
                _ => other.ToHashSet(Comparer.ToEqualityComparer()).IsSupersetOf(Link)
            };
        }
        ...
        public Boolean IsProperSubsetOf(IEnumerable<T> other)
        {
            ...
            return other switch
            {
                ISet<T> set => set.IsProperSupersetOf(Link),
                IImmutableSet<T> set => set.IsProperSupersetOf(Link),
                IReadOnlySet<T> set => set.IsProperSupersetOf(Link),
                _ => other.ToHashSet(Comparer.ToEqualityComparer()).IsProperSupersetOf(Link)
            };
        }
        ...
        public Boolean IsSupersetOf(IEnumerable<T> other)
        {
            ...
            return other switch
            {
                ISet<T> set => set.IsSubsetOf(Link),
                IImmutableSet<T> set => set.IsSubsetOf(Link),
                IReadOnlySet<T> set => set.IsSubsetOf(Link),
                _ => other.ToHashSet(Comparer.ToEqualityComparer()).IsSubsetOf(Link)
            };
        }
        ...
        public Boolean IsProperSupersetOf(IEnumerable<T> other)
        {
            ...
            return other switch
            {
                ISet<T> set => set.IsProperSubsetOf(Link),
                IImmutableSet<T> set => set.IsProperSubsetOf(Link),
                IReadOnlySet<T> set => set.IsProperSubsetOf(Link),
                _ => other.ToHashSet(Comparer.ToEqualityComparer()).IsProperSubsetOf(Link)
            };
        }
        ...
        public Boolean SetEquals(IEnumerable<T> other)
        {
            ...
            return other switch
            {
                ISet<T> set => set.SetEquals(Link),
                IImmutableSet<T> set => set.SetEquals(Link),
                IReadOnlySet<T> set => set.SetEquals(Link),
                _ => other.ToHashSet(Comparer.ToEqualityComparer()).SetEquals(Link)
            };
        }
        ...
        public void SymmetricExceptWith(IEnumerable<T> other)
        {
            ...
            foreach (T item in other.Distinct(Comparer.ToEqualityComparer()))
            {
                if (Contains(item))
                {
                    Remove(item);
