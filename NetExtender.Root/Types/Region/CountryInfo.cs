    ...
    public partial class CountryInfo
    {
        ...
        private static class CountryInfoStorage
        {
            ...
            static CountryInfoStorage()
            {
                ...
                ImmutableDictionary<CountryIdentifier, CountryInfoData> cache = EnumUtilities.GetValuesWithoutDefault<CountryIdentifier>().ToImmutableDictionary(static identifier => identifier, Create);
                IdentifierStorage = cache.ToImmutableDictionary(static pair => pair.Key, static pair => pair.Value.ToInfo());
                ...
                IdentifierStorage = IdentifierStorage.ToImmutableDictionary(static pair => pair.Key, pair => Hack(pair.Value, cache[pair.Key], setter));
                CodeStorage = IdentifierStorage.Values.ToImmutableDictionary(static country => country.Code, static country => country);
                NameStorage = IdentifierStorage.Values.ToImmutableDictionary(static country => country.Name, static country => country, StringComparer.OrdinalIgnoreCase);
                OfficialNameStorage = IdentifierStorage.Values.ToImmutableDictionary(static country => country.OfficialName, static country => country, StringComparer.OrdinalIgnoreCase);
                NativeNameStorage = IdentifierStorage.Values.ToImmutableDictionary(static country => country.NativeName, static country => country, StringComparer.OrdinalIgnoreCase);
                Iso2Storage = IdentifierStorage.Values.ToImmutableDictionary(static country => country.TwoLetterISOCountryName, static country => country, StringComparer.OrdinalIgnoreCase);
            }
