...
namespace NetExtender.Monads
{
    ...
    {
        internal static class W3C
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RayId Create(UInt64 span, RayIdFlags flags)
            {
                const Byte metadata = (Byte) RayIdFormat.W3C << 6 | (Byte) Mask.ServerGenerated;
            ...
            {
                const Byte metadata = (Byte) RayIdFormat.W3C << 6 | (Byte) Mask.Timestamp | (Byte) Mask.ServerGenerated;
            ...
            {
                const Byte metadata = (Byte) RayIdFormat.W3C << 6 | (Byte) Mask.ServerGenerated | (Byte) Mask.UsingHash;
            ...
            {
                const Byte metadata = (Byte) RayIdFormat.W3C << 6 | (Byte) Mask.Timestamp | (Byte) Mask.ServerGenerated | (Byte) Mask.UsingHash;
