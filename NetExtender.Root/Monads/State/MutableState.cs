...
namespace NetExtender.Types.Monads
{
    ...
    public class MutableState<T> : IState<T>, IStateEquality<T, State<T>>, IStateEquality<T, MutableState<T>>, ICloneable<State<T>>, ICloneable<MutableState<T>>, ISerializable
    {
        ...
        {
            return _internal.ReferenceEquals(other, equality);
        }
        ...
        public Boolean ReferenceEquals(MutableState<T>? other)
        {
            return other is not null && _internal.ReferenceEquals(other._internal);
        }

        public Boolean ReferenceEquals(MutableState<T>? other, StateEquality equality)
        {
            return other is not null && _internal.ReferenceEquals(other._internal, equality);
        }
