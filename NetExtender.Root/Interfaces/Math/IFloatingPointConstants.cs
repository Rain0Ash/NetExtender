...
namespace NetExtender.Interfaces
{
    ...
    public interface IInheritFloatingPointConstants<TSelf> : INetExtenderFloatingPointConstants<TSelf>, IInheritNumberBase<TSelf>
#if NET7_0_OR_GREATER
        , IFloatingPointConstants<TSelf> where TSelf : IInheritFloatingPointConstants<TSelf>?
#endif
    {
        public new const NumericsInterfaceGroup Group = INetExtenderFloatingPointConstants<TSelf>.Group | IInheritNumberBase<TSelf>.Group;
        public new const BinaryOperator Operator = INetExtenderFloatingPointConstants<TSelf>.Operator | IInheritNumberBase<TSelf>.Operator;
        public new const UnaryOperator UnaryOperator = INetExtenderFloatingPointConstants<TSelf>.UnaryOperator | IInheritNumberBase<TSelf>.UnaryOperator;
        public new const BinaryOperator BinaryOperator = INetExtenderFloatingPointConstants<TSelf>.BinaryOperator | IInheritNumberBase<TSelf>.BinaryOperator;
        ...
        public new static Boolean IsSupported
        {
            ...
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderFloatingPointConstants<TSelf>, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set>.IsSupported;
            }
        }

        protected internal new static INetExtenderFloatingPointConstants<TSelf>.OperatorHandler Handler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderFloatingPointConstants<TSelf>, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set>.Handler;
            }
        }

        protected internal new static INetExtenderFloatingPointConstants<TSelf>.OperatorHandler SafeHandler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderFloatingPointConstants<TSelf>, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set>.SafeHandler;
            }
        }

        protected internal new static INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set Storage
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderFloatingPointConstants<TSelf>, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set>.Storage;
            }
        }
        ...
        {
            return INetExtenderOperator<TSelf, INetExtenderFloatingPointConstants<TSelf>, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set>.Ensure();
        }

        [ReflectionSignature]
        public new static TSelf E
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderFloatingPointConstants<TSelf>.E;
            }
        }

        [ReflectionSignature]
        public new static TSelf Pi
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderFloatingPointConstants<TSelf>.Pi;
            }
        }

        [ReflectionSignature]
        public new static TSelf Tau
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderFloatingPointConstants<TSelf>.Tau;
            }
        }
        ...
        INetExtenderOperator<TSelf, INetExtenderFloatingPointConstants<TSelf>, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set>
    {
        ...
        public new sealed class OperatorHandler : INetExtenderOperator.OperatorHandler<TSelf, INetExtenderFloatingPointConstants<TSelf>, INetExtenderFloatingPointConstants<TSelf>.OperatorHandler.Set>
        {
            ...
            {
                internal readonly Func<TSelf> E = null!;
                internal readonly Func<TSelf> Pi = null!;
                internal readonly Func<TSelf> Tau = null!;
            }
            ...
            protected override IEnumerable<Result<INetExtenderOperator.OperatorHandler>> Initialize(Set set)
            {
                ...
                if (Set(in set.E, Initialize<TSelf>(this, nameof(E))) is null)
                {
                    yield return Exception<TSelf>(this, nameof(E));
                }

                if (Set(in set.Pi, Initialize<TSelf>(this, nameof(Pi))) is null)
                {
                    yield return Exception<TSelf>(this, nameof(Pi));
                }

                if (Set(in set.Tau, Initialize<TSelf>(this, nameof(Tau))) is null)
                {
