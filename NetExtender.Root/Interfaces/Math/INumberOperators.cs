...
namespace NetExtender.Interfaces
{
    ...
    public interface IInheritNumberOperators<TSelf> : IInheritNumberBaseOperators<TSelf>, INetExtenderNumberOperators<TSelf>, IInheritComparisonOperators<TSelf>, IInheritMathOperators<TSelf>
#if NET7_0_OR_GREATER
        where TSelf : IInheritNumberOperators<TSelf>?
#endif
    {
        public new const NumericsInterfaceGroup Group = IInheritNumberBaseOperators<TSelf>.Group | INetExtenderNumberOperators<TSelf>.Group | IInheritComparisonOperators<TSelf>.Group | IInheritMathOperators<TSelf>.Group;
        public new const BinaryOperator Operator = IInheritNumberBaseOperators<TSelf>.Operator | INetExtenderNumberOperators<TSelf>.Operator | IInheritComparisonOperators<TSelf>.Operator | IInheritMathOperators<TSelf>.Operator;
        public new const UnaryOperator UnaryOperator = IInheritNumberBaseOperators<TSelf>.UnaryOperator | INetExtenderNumberOperators<TSelf>.UnaryOperator;
        public new const BinaryOperator BinaryOperator = IInheritNumberBaseOperators<TSelf>.BinaryOperator | INetExtenderNumberOperators<TSelf>.BinaryOperator | IInheritComparisonOperators<TSelf>.Operator | IInheritMathOperators<TSelf>.Operator;
        ...
        public new static Boolean IsSupported
        {
            ...
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberOperators<TSelf>, INetExtenderNumberOperators<TSelf>.OperatorHandler, INetExtenderNumberOperators<TSelf>.OperatorHandler.Set>.IsSupported;
            }
        }

        protected internal new static INetExtenderNumberOperators<TSelf>.OperatorHandler Handler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberOperators<TSelf>, INetExtenderNumberOperators<TSelf>.OperatorHandler, INetExtenderNumberOperators<TSelf>.OperatorHandler.Set>.Handler;
            }
        }

        protected internal new static INetExtenderNumberOperators<TSelf>.OperatorHandler SafeHandler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberOperators<TSelf>, INetExtenderNumberOperators<TSelf>.OperatorHandler, INetExtenderNumberOperators<TSelf>.OperatorHandler.Set>.SafeHandler;
            }
        }

        protected internal new static INetExtenderNumberOperators<TSelf>.OperatorHandler.Set Storage
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberOperators<TSelf>, INetExtenderNumberOperators<TSelf>.OperatorHandler, INetExtenderNumberOperators<TSelf>.OperatorHandler.Set>.Storage;
            }
        }
        ...
        {
            return INetExtenderOperator<TSelf, INetExtenderNumberOperators<TSelf>, INetExtenderNumberOperators<TSelf>.OperatorHandler, INetExtenderNumberOperators<TSelf>.OperatorHandler.Set>.Ensure();
        }
    ...
    [SuppressMessage("ReSharper", "MemberHidesStaticFromOuterClass")]
    public interface IInheritNumberBaseOperators<TSelf> : INetExtenderNumberBaseOperators<TSelf>, IInheritEqualityOperators<TSelf>, IInheritStepOperators<TSelf>, IInheritUnaryOperators<TSelf>, IInheritMathBaseOperators<TSelf>
#if NET7_0_OR_GREATER
        where TSelf : IInheritNumberBaseOperators<TSelf>?
#endif
    {
        public new const NumericsInterfaceGroup Group = INetExtenderNumberBaseOperators<TSelf>.Group | IInheritEqualityOperators<TSelf>.Group | IInheritStepOperators<TSelf>.Group | IInheritUnaryOperators<TSelf>.Group | IInheritMathBaseOperators<TSelf>.Group;
        public new const BinaryOperator Operator = INetExtenderNumberBaseOperators<TSelf>.Operator | IInheritEqualityOperators<TSelf>.Operator | IInheritMathBaseOperators<TSelf>.Operator;
        public new const UnaryOperator UnaryOperator = INetExtenderNumberBaseOperators<TSelf>.UnaryOperator | IInheritStepOperators<TSelf>.Operator | IInheritUnaryOperators<TSelf>.Operator;
        public new const BinaryOperator BinaryOperator = INetExtenderNumberBaseOperators<TSelf>.BinaryOperator | IInheritEqualityOperators<TSelf>.Operator | IInheritMathBaseOperators<TSelf>.Operator;
        ...
        public new static Boolean IsSupported
        {
            ...
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberBaseOperators<TSelf>, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler.Set>.IsSupported;
            }
        }

        protected internal new static INetExtenderNumberBaseOperators<TSelf>.OperatorHandler Handler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberBaseOperators<TSelf>, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler.Set>.Handler;
            }
        }

        protected internal new static INetExtenderNumberBaseOperators<TSelf>.OperatorHandler SafeHandler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberBaseOperators<TSelf>, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler.Set>.SafeHandler;
            }
        }

        protected internal new static INetExtenderNumberBaseOperators<TSelf>.OperatorHandler.Set Storage
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderNumberBaseOperators<TSelf>, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler.Set>.Storage;
            }
        }
        ...
        public new static AggregateException? Ensure()
        {
            return INetExtenderOperator<TSelf, INetExtenderNumberBaseOperators<TSelf>, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler, INetExtenderNumberBaseOperators<TSelf>.OperatorHandler.Set>.Ensure();
        }
