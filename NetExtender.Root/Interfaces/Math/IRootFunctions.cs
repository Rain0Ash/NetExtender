...
namespace NetExtender.Interfaces
{
    ...
    public interface IInheritRootFunctions<TSelf> : INetExtenderRootFunctions<TSelf>, IInheritFloatingPointConstants<TSelf>
#if NET7_0_OR_GREATER
        , IRootFunctions<TSelf> where TSelf : IInheritRootFunctions<TSelf>?
#endif
    {
        public new const NumericsInterfaceGroup Group = INetExtenderRootFunctions<TSelf>.Group | IInheritFloatingPointConstants<TSelf>.Group;
        public new const BinaryOperator Operator = INetExtenderRootFunctions<TSelf>.Operator | IInheritFloatingPointConstants<TSelf>.Operator;
        public new const UnaryOperator UnaryOperator = INetExtenderRootFunctions<TSelf>.UnaryOperator | IInheritFloatingPointConstants<TSelf>.UnaryOperator;
        public new const BinaryOperator BinaryOperator = INetExtenderRootFunctions<TSelf>.BinaryOperator | IInheritFloatingPointConstants<TSelf>.BinaryOperator;
        ...
        public new static Boolean IsSupported
        {
            ...
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderRootFunctions<TSelf>, INetExtenderRootFunctions<TSelf>.OperatorHandler, INetExtenderRootFunctions<TSelf>.OperatorHandler.Set>.IsSupported;
            }
        }

        protected internal new static INetExtenderRootFunctions<TSelf>.OperatorHandler Handler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderRootFunctions<TSelf>, INetExtenderRootFunctions<TSelf>.OperatorHandler, INetExtenderRootFunctions<TSelf>.OperatorHandler.Set>.Handler;
            }
        }

        protected internal new static INetExtenderRootFunctions<TSelf>.OperatorHandler SafeHandler
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderRootFunctions<TSelf>, INetExtenderRootFunctions<TSelf>.OperatorHandler, INetExtenderRootFunctions<TSelf>.OperatorHandler.Set>.SafeHandler;
            }
        }

        protected internal new static INetExtenderRootFunctions<TSelf>.OperatorHandler.Set Storage
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                return INetExtenderOperator<TSelf, INetExtenderRootFunctions<TSelf>, INetExtenderRootFunctions<TSelf>.OperatorHandler, INetExtenderRootFunctions<TSelf>.OperatorHandler.Set>.Storage;
            }
        }
        ...
        {
            return INetExtenderOperator<TSelf, INetExtenderRootFunctions<TSelf>, INetExtenderRootFunctions<TSelf>.OperatorHandler, INetExtenderRootFunctions<TSelf>.OperatorHandler.Set>.Ensure();
        }

        [ReflectionSignature]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Sqrt(TSelf value)
        {
            return INetExtenderRootFunctions<TSelf>.Sqrt(value);
        }

        [ReflectionSignature]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Cbrt(TSelf value)
        {
            return INetExtenderRootFunctions<TSelf>.Cbrt(value);
        }

        [ReflectionSignature]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf RootN(TSelf value, Int32 root)
        {
            return INetExtenderRootFunctions<TSelf>.RootN(value, root);
        }

        [ReflectionSignature]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Hypot(TSelf x, TSelf y)
        {
            return INetExtenderRootFunctions<TSelf>.Hypot(x, y);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static Boolean Equality(TSelf first, TSelf second)
        {
            return INetExtenderRootFunctions<TSelf>.Equality(first, second);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static Boolean Inequality(TSelf first, TSelf second)
        {
            return INetExtenderRootFunctions<TSelf>.Inequality(first, second);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Increment(TSelf value)
        {
            return INetExtenderRootFunctions<TSelf>.Increment(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Decrement(TSelf value)
        {
            return INetExtenderRootFunctions<TSelf>.Decrement(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf UnaryPlus(TSelf value)
        {
            return INetExtenderRootFunctions<TSelf>.UnaryPlus(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf UnaryNegation(TSelf value)
        {
            return INetExtenderRootFunctions<TSelf>.UnaryNegation(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Addition(TSelf first, TSelf second)
        {
            return INetExtenderRootFunctions<TSelf>.Addition(first, second);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Subtraction(TSelf first, TSelf second)
        {
            return INetExtenderRootFunctions<TSelf>.Subtraction(first, second);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Multiply(TSelf first, TSelf second)
        {
            return INetExtenderRootFunctions<TSelf>.Multiply(first, second);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public new static TSelf Division(TSelf first, TSelf second)
        {
            return INetExtenderRootFunctions<TSelf>.Division(first, second);
        }
        ...
        public new static class Checked
        {
            ...
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Equality(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Boolean Inequality(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Inequality(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Increment(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Increment(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Decrement(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Decrement(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf UnaryPlus(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.UnaryPlus(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf UnaryNegation(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.UnaryNegation(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Addition(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Addition(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Subtraction(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Subtraction(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Multiply(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Multiply(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Division(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Checked.Division(first, second);
            }
        }
        ...
        public new static class Unchecked
        {
            ...
            public static Boolean Equality(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Equality(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Boolean Inequality(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Inequality(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Increment(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Increment(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Decrement(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Decrement(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf UnaryPlus(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.UnaryPlus(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf UnaryNegation(TSelf value)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.UnaryNegation(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Addition(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Addition(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Subtraction(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Subtraction(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Multiply(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Multiply(first, second);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TSelf Division(TSelf first, TSelf second)
            {
                return INetExtenderRootFunctions<TSelf>.Unchecked.Division(first, second);
            }
        }
        ...
        INetExtenderOperator<TSelf, INetExtenderRootFunctions<TSelf>, INetExtenderRootFunctions<TSelf>.OperatorHandler, INetExtenderRootFunctions<TSelf>.OperatorHandler.Set>
    {
        ...
        {
            return Storage.Sqrt.Invoke(value);
        }
        ...
        {
            return Storage.Cbrt.Invoke(value);
        }
        ...
        {
            return Storage.RootN.Invoke(value, root);
        }
        ...
        {
            return Storage.Hypot.Invoke(x, y);
        }
        ...
        public new sealed class OperatorHandler : INetExtenderOperator.OperatorHandler<TSelf, INetExtenderRootFunctions<TSelf>, INetExtenderRootFunctions<TSelf>.OperatorHandler.Set>
        {
            ...
            {
                internal readonly Func<TSelf, TSelf> Sqrt = null!;
                internal readonly Func<TSelf, TSelf> Cbrt = null!;
                internal readonly Func<TSelf, Int32, TSelf> RootN = null!;
                internal readonly Func<TSelf, TSelf, TSelf> Hypot = null!;
            }
            ...
            protected override IEnumerable<Result<INetExtenderOperator.OperatorHandler>> Initialize(Set set)
            {
                ...
                if (Set(in set.Sqrt, INetExtenderOperator.Initialize(this, Sqrt)) is null)
                {
                    yield return Exception(this, Sqrt);
                }

                if (Set(in set.Cbrt, INetExtenderOperator.Initialize(this, Cbrt)) is null)
                {
                    yield return Exception(this, Cbrt);
                }

                if (Set(in set.RootN, INetExtenderOperator.Initialize(this, RootN)) is null)
                {
                    yield return Exception(this, RootN);
                }

                if (Set(in set.Hypot, INetExtenderOperator.Initialize(this, Hypot)) is null)
                {
