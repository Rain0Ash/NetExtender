    ...
    public static partial class Software
    {
        ...
        public static String Edition
        {
            get
            {
                ...
                WindowsSystemVersionInfo versioninfo = new WindowsSystemVersionInfo
                {
                    SystemVersionInfoSize = Marshal.SizeOf(typeof(WindowsSystemVersionInfo))
                };
                ...
                Byte product = versioninfo.ProductType;
                Int16 suitemask = versioninfo.SuiteMask;
                ...
                switch (major)
                {
                    ...
                    case 6:
                    {
                        if (GetProductInfo(major, minor,
                            versioninfo.ServicePackMajor, versioninfo.ServicePackMinor,
                            out Int32 ed))
                        {
                            edition = ed switch
                            {
        ...
        public static String Name
        {
            get
            {
                ...
                if (major == 6 && minor == 2)
                {
                    ...
                    String? exactversion = SystemVersionRegistry;
                ...
                switch (version.Platform)
                {
                    ...
                    case PlatformID.Win32Windows:
                    {
                        if (major == 4)
                        {
                            String csdVersion = versioninfo.Version;
                            switch (minor)
                            {
                                case 0:
                    ...
                    {
                        Byte productType = versioninfo.ProductType;
