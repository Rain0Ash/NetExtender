...
namespace NetExtender.Utilities.Types
{
    public static class SizeUtilities
    {
        ...
        public static Size AspectRatioBoundsSize(this Size original, Size bounds)
        {
            ...
            result.Height = (Int32) DrawingUtilities.GetAspectRatio(original.Height, difference);
            ...
            difference = DrawingUtilities.GetAspectRatio(result.Height, bounds.Height);
            result.Width = (Int32) DrawingUtilities.GetAspectRatio(bounds.Width, difference);
