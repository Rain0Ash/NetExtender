    ...
    public static partial class KeyboardUtilities
    {
        ...
        public static class Toggle
        {
            ...
            public static Boolean Alt
            {
                get
                {
                    return KeyboardUtilities.Alt.IsAltToggled;
                }
            }
            ...
            public static Boolean Shift
            {
                get
                {
                    return KeyboardUtilities.Shift.IsShiftToggled;
                }
            }
            ...
            public static Boolean Control
            {
                get
                {
                    return KeyboardUtilities.Control.IsControlToggled;
                }
            }
            ...
            public static Boolean Windows
            {
                get
                {
                    return KeyboardUtilities.Windows.IsWindowsToggled;
                }
            }
        }
    }
