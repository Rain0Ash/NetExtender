...
namespace NetExtender.Protocols
{
    ...
    {
        public static KeyValuePair<String?, String?>? GetFileTypeAssociation([NotNull] String extension)
        {
        ...
        public static IEnumerable<KeyValuePair<String, KeyValuePair<String?, String?>>> GetFileTypeAssociation()
        {
            ...
            foreach (String entry in registry.GetSubKeyNames())
            {
        ...
        {
            return GetFileTypeAssociationUserChoice()
                .Select(KeyValuePairUtils.FlattenByKey);
        }

        public static IEnumerable<KeyValuePair<String?, String?>> GetFileTypeAssociationHashUserChoice()
        {
            return GetFileTypeAssociationUserChoice()
                .Select(KeyValuePairUtils.FlattenByValue);
        }
