...
namespace System.Security.Cryptography
{
    ...
    {
        private const Int32 BLOCK_SIZE_BYTES = 64;
        ...
        public SHA224Managed()
        {
            ...
            ProcessingBuffer = new Byte [BLOCK_SIZE_BYTES];
        ...
        protected override void HashCore(Byte[] rgb, Int32 start, Int32 size)
        {
            unchecked
            {
                ...
                {
                    if (size < BLOCK_SIZE_BYTES - ProcessingBufferCount)
                    {
                    ...
                    i = BLOCK_SIZE_BYTES - ProcessingBufferCount;
                ...
                BlockCopy(rgb, size - size % BLOCK_SIZE_BYTES + start, ProcessingBuffer, 0, size % BLOCK_SIZE_BYTES);
                ProcessingBufferCount = size % BLOCK_SIZE_BYTES;
            }
        }
        ...
        private void ProcessFinalBlock(Span<Byte> inputBuffer, Int32 inputOffset, Int32 inputCount)
        {
            unchecked
            {
                ...
                Int32 paddingSize = 56 - (Int32) (total % BLOCK_SIZE_BYTES);
