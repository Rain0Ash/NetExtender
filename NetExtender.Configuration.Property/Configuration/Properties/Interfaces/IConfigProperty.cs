...
{
    public interface IConfigProperty<T> : IConfigPropertyValueInfo<T>, IChangeableBehavior<ConfigPropertyOptions>, IReadOnlyValidable<T>, IGetter<T>, IAsyncGetter<T>, ISetter<T>, IAsyncSetter<T>, IFormattable
    {
