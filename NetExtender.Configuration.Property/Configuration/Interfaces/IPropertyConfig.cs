...
namespace NetExtender.Configuration.Property.Interfaces
{
    public interface IPropertyConfig : IConverterConfig, IPropertyConfigBase
    {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, CryptAction crypt, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, ICryptKey? crypt, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, Func<ICryptKey?>? crypt, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, Func<String?, ICryptKey?>? crypt, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, Func<String?, String[]?, ICryptKey?>? crypt, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, CryptAction crypt, ConfigPropertyOptions options, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, ICryptKey? crypt, ConfigPropertyOptions options, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, Func<ICryptKey?>? crypt, ConfigPropertyOptions options, IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, Func<String?, ICryptKey?>? crypt, ConfigPropertyOptions options,
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, Func<String?, String[]?, ICryptKey?>? crypt, ConfigPropertyOptions options,
            IEnumerable<String>? sections)
        {
            String[]? array = sections?.ToArray();
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, CryptAction crypt, ConfigPropertyOptions options, TryConverter<String?, T>? converter,
            IEnumerable<String>? sections)
        {
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, ICryptKey? crypt, ConfigPropertyOptions options, TryConverter<String?, T>? converter,
            IEnumerable<String>? sections);
        ...
        public IConfigProperty<T> GetProperty<T>(String key, T value, Func<T, Boolean>? validate, Func<ICryptKey?>? crypt, ConfigPropertyOptions options,
